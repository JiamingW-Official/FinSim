...
function MiniCandlestickSVG() {
  return (
    <svg
      viewBox="0 0 120 60"
      className="mx-auto mt-4 h-16 w-32 text-green-500"
      aria-hidden
    >
      {/* Wicks */}
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-background/95 backdrop-blur-sm">
      <div className="flex w-full max-w-md flex-col items-center px-4">
        <div className="relative w-full overflow-hidden rounded-lg border bg-card p-8 shadow-sm">
          <AnimatePresence mode="wait" custom={direction}>
            ...
            >
              ...
              <div
                className={cn(
                  "mb-5 flex h-16 w-16 items-center justify-center rounded-full shadow-sm",
                  step.iconBg
                )}
              >
                {step.icon}
          ...
          <div className="mt-8 flex flex-col items-center gap-3">
            <button
              ...
              className={cn(
                ...
                "bg-primary hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
              )}
            >
              {isFirstStep
                ? "Get Started"
