...
export function PlayerStatsCard() {
  ...
  const statItems = [
    ...
    },
    {
      ...
      color: winRate >= 50 ? "text-green-400" : "text-muted-foreground",
      icon: Target,
    },
    {
      label: "Win Streak",
  ...
  return (
    <motion.div
      className={cn(
        "card-hover-glow rounded-lg border p-4",
    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        <motion.div
          className={cn(
            "flex h-12 w-12 shrink-0 items-center justify-center rounded-lg text-xl font-black text-white bg-primary",
