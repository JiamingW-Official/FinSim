      ...
      <div className="flex shrink-0 items-center gap-2 text-xs text-muted-foreground">
        ...
        {currentBar && (
          <>
            ...
            <span className="hidden whitespace-nowrap text-muted-foreground text-[10px] sm:block">
              {formatDateLabel(currentBar.timestamp)}
            </span>
          </>
        )}
        {atEnd && (
          <span className="rounded bg-red-500/10 px-1.5 py-0.5 text-[9px] font-bold text-red-500">
            END
          </span>
        )}
      </div>
