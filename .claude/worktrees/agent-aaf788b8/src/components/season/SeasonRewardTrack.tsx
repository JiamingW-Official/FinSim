            ...
            <div key={tier.tier} className="flex items-center">
              ...
              {i > 0 && (
                <div
                  className={cn(
                    "h-0.5 w-4 shrink-0",
                    isClaimed ? "bg-amber-500/50" : isAvailable ? "bg-amber-500/30" : "bg-muted/50",
                  )}
                />
              )}
              ...
              <div className="group relative">
                <motion.button
                  ...
                  className={cn(
                    "season-tier-unlock relative flex h-12 w-12 shrink-0 flex-col items-center justify-center rounded-lg border-2 transition-all",
                    isClaimed
                      ? "border-amber-500/50 bg-amber-500/10 text-amber-400"
                      : isAvailable
                        ? "border-amber-500 bg-amber-500/20 text-amber-300 shadow-sm shadow-amber-500/20 cursor-pointer animate-pulse"
                        : isCurrent
                ...
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 hidden group-hover:block z-20">
                  <div className="rounded-lg border border-border bg-card px-3 py-2 shadow-sm whitespace-nowrap text-center">
                    <p className="text-[10px] font-bold text-foreground">{tier.reward.label}</p>
                    <p className="text-[9px] text-muted-foreground mt-0.5">{tier.xpRequired} XP required</p>
                  </div>
                </div>
              </div>
            </div>
