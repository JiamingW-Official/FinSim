    ...
    <div className="space-y-4 p-4">
      ...
      <div className="flex items-center gap-3 rounded-lg border border-border/50 bg-muted/30 px-4 py-3">
        <div className="flex-1 text-center">
          <div className="text-[9px] uppercase text-muted-foreground/60">Worst Case</div>
          <div className="text-sm font-bold text-rose-400">{dist.min > 0 ? "+" : ""}{dist.min}%</div>
        </div>
        <div className="h-8 w-px bg-muted/50" />
        <div className="flex-1 text-center">
          <div className="text-[9px] uppercase text-muted-foreground/60">Median</div>
          <div className="text-sm font-bold text-foreground">{dist.median > 0 ? "+" : ""}{dist.median}%</div>
        </div>
        <div className="h-8 w-px bg-muted/50" />
        <div className="flex-1 text-center">
          <div className="text-[9px] uppercase text-muted-foreground/60">Best Case</div>
          <div className="text-sm font-bold text-green-400">{dist.max > 0 ? "+" : ""}{dist.max}%</div>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-5 gap-1">
          {[10, 25, 50, 75, 90].map((pct) => {
            ...
            return (
              <div key={pct} className="rounded-lg border border-border/50 bg-muted/30 p-2 text-center">
                <div className="text-[9px] text-muted-foreground/60">P{pct}</div>
