        ...
        <div className="border border-border rounded-lg p-3 bg-muted/20 space-y-2">
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="flex-1 text-[11px] bg-background border border-border rounded px-2 py-1 outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-colors"
            >
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              className="flex-1 text-[11px] font-mono tabular-nums bg-background border border-border rounded px-2 py-1 outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-colors"
