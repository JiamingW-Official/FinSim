...
import { GraduationCap, BookOpen, Flame, Brain, TrendingUp, Check, Calculator, History, ChevronDown, ChevronUp, Map, GitCompare } from "lucide-react";
...
import { DailyLessonCard } from "@/components/education/DailyLessonCard";
...
import { PracticeExercises } from "@/components/education/PracticeExercises";
...
export function LearnPageClient() {
  ...
  const [conceptComparisonOpen, setConceptComparisonOpen] = useState(false);
    ...
    <div className="flex h-full flex-col overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-6">
        <div className="mx-auto max-w-md">
          ...
          {/* Daily Micro-Lesson — highlighted card at top */}
          <div className="mb-5">
          ...
          {/* Skill tree (SkillPath — existing Duolingo-style nodes) */}
          <SkillPath />
          ...
          {/* Compare Concepts — collapsible */}
          <div className="mt-6">
            <button
              type="button"
              onClick={() => setConceptComparisonOpen((prev) => !prev)}
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-medium">Compare Concepts</span>
              </div>
              {conceptComparisonOpen ? (
