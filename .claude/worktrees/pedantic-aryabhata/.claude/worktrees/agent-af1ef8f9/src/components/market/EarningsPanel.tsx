...
function BeatMeter({ probability }: { probability: number }) {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <span className="font-mono tabular-nums text-[10px] font-medium w-8 text-right">
        {probability}%
      </span>
    </div>
  );
...
function EarningsCard({
  ...
  return (
    <div className="rounded-lg border bg-card hover:border-border/60 transition-colors">
      <button
        onClick={onToggle}
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 mt-2">
          ...
          <div>
            <p className="text-[10px] text-muted-foreground">Model Pred.</p>
            <p
              className={cn(
          ...
          <div>
            <p className="text-[10px] text-muted-foreground">Hist. Beat</p>
            <p className="font-mono tabular-nums text-xs font-medium">
