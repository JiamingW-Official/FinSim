...
const DIFFICULTY_CONFIG = {
  beginner: { bg: "bg-green-500/15", text: "text-green-500", glow: "shadow-[0_0_8px_rgba(16,185,129,0.15)]", label: "Beginner" },
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        <motion.div
          className={cn(
            "flex h-10 w-10 items-center justify-center rounded-lg text-lg font-black shrink-0",
            isComplete
          ...
          {isComplete && progress?.finalPnL != null ? (
            <motion.div
              ...
              className={cn(
                ...
                progress.finalPnL >= 0 ? "bg-green-500/10 text-green-400" : "bg-red-500/10 text-red-400",
              )}
            >
