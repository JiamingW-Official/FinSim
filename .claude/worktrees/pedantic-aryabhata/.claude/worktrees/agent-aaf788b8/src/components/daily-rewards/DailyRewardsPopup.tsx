      ...
      {show && (
        ...
        >
          <motion.div
            ...
            className="relative w-full max-w-[420px] mx-4 overflow-hidden rounded-lg border border-border/60 bg-card shadow-sm"
          ...
          >
            ...
            <div className={cn(
              ...
              <motion.div
                className={cn(
                  "flex h-16 w-16 items-center justify-center rounded-lg text-3xl border",
                  isDay7
                ...
                {DAY_REWARDS.map((xp, i) => {
                  ...
                  return (
                    <motion.div
                      key={i}
                      className={cn(
                        "relative flex flex-col items-center gap-1 rounded-lg border py-2.5 px-1 transition-all",
                        isClaimed
            ...
            <div className="px-5 pb-5 space-y-3">
              ...
              >
                {claimed ? (
                  <motion.div
                    className="flex items-center justify-center gap-2.5 rounded-lg border border-green-500/30 bg-green-500/12 px-5 py-3"
                    initial={{ scale: 0.85 }}
                    animate={{ scale: 1 }}
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.96 }}
                    className={cn(
                      "w-full rounded-lg py-3 text-sm font-black text-white transition-all",
                      isDay7
                  ...
                  <div className="flex items-center justify-center gap-2 rounded-lg border border-border/30 bg-muted/10 px-5 py-3">
                    <Check className="h-4 w-4 text-green-400" />
