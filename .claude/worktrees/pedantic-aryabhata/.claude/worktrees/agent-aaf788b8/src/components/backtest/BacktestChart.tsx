...
export default function BacktestChart({ bars, trades, isRunning, isPreview, onRegenerate }: BacktestChartProps) {
  ...
  return (
    <div className="relative flex-1 overflow-hidden">
      {isRunning && (
        <div className="backtest-running absolute inset-0 z-10 flex items-center justify-center bg-background/60">
        ...
        <div className="absolute left-3 top-3 z-10 flex items-center gap-2">
          ...
          {onRegenerate && (
            <button
              ...
              className="flex h-7 w-7 items-center justify-center rounded-lg border border-border bg-card/90 text-muted-foreground shadow-sm backdrop-blur transition-colors hover:bg-violet-500/20 hover:text-violet-300 cursor-pointer"
            >
