  ...
  return (
    <AnimatePresence>
      {current && (
        ...
        >
          <div
            className="achievement-confetti relative flex items-center gap-3 rounded-lg border border-amber-500/30 bg-card px-4 py-3 shadow-sm glow-amber cursor-pointer"
