...
export function StrategyRecommendationCard({
  ...
  return (
    <motion.div
      ...
      className="rounded-lg border border-border/50 bg-card p-2.5 flex flex-col gap-2 cursor-pointer hover:border-primary/30 transition-colors"
    >
      ...
      <div className="flex justify-between items-start gap-1">
        ...
        <span
          className={cn(
            ...
            SENTIMENT_STYLES[preset.sentiment] ?? "bg-muted/20 text-muted-foreground",
          )}
        >
      ...
      <div className="grid grid-cols-2 gap-1 text-[9px]">
        ...
        <div className="flex gap-1 items-baseline">
          ...
          <span className="font-bold text-green-400">{formatPnlLabel(maxProfit)}</span>
        </div>
        <div className="flex gap-1 items-baseline">
