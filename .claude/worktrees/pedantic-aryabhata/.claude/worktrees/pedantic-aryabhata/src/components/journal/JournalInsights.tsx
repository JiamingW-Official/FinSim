...
function TradeNarratives({ rows, emotions }: {
 ...
 if (rows.length === 0) {
 return (
 <div className="rounded-lg border border-dashed border-border flex h-24 items-center justify-center">
...
function HabitTracking({ rows, rng }: { rows: TradeRow[]; rng: () => number }) {
 ...
 : "bg-muted/20 text-muted-foreground border border-border hover:border-border"
 )}
 >
 <div className={cn(
