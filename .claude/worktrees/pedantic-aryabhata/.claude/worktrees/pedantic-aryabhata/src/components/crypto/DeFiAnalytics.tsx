...
function GasTracker({ gasPrice }: { gasPrice: GasPrice }) {
 ...
 className="w-full rounded-md border border-border bg-background px-3 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring mb-3"
 >
 {ACTION_TYPES.map((a) => (
...
function YieldAggregator({ yields }: { yields: YieldOpportunity[] }) {
 ...
 <div className="rounded-md bg-muted/20 border border-border px-3 py-2.5 text-muted-foreground leading-relaxed">
