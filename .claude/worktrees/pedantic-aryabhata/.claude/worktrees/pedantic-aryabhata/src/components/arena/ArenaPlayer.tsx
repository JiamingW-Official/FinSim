...
export function ArenaPlayer({ config, opponent, onFinish, onCancel }: ArenaPlayerProps) {
 ...
 {/* ═══ Top HUD ═══ */}
 <div className="flex flex-col border-b border-border bg-black/60">
 ...
 <div className="flex items-center gap-2 px-3 py-1 border-t border-border">
 {/* Player label */}
 ...
 className="rounded-lg border border-border bg-muted/20 px-4 py-2 text-xs font-semibold text-muted-foreground transition-colors hover:bg-muted/50">
 Continue
 </button>
