...
export function AdaptiveFlashcards({ onSessionStats }: AdaptiveFlashcardsProps) {
 ...
 <span>
 <kbd className="rounded border border-border bg-muted px-1 font-mono">Space</kbd> flip card
 </span>
 <span>
 ...
 <span>
 <kbd className="rounded border border-border bg-muted px-1 font-mono">1</kbd> Again
 </span>
 <span>
 <kbd className="rounded border border-border bg-muted px-1 font-mono">2</kbd> Hard
 </span>
 <span>
 <kbd className="rounded border border-border bg-muted px-1 font-mono">3</kbd> Easy
 </span>
 </div>
 </div>
 </motion.div>
 ...
 >
 {/* Front */}
 <div className="card-flip-front min-h-[220px] rounded-md border border-border bg-card p-5 flex flex-col items-center justify-center gap-3">
 ...
 className="flex items-center gap-1 rounded-md border border-border bg-muted/20 px-2.5 py-1.5 text-[11px] font-medium text-muted-foreground transition-colors hover:border-border hover:text-foreground disabled:pointer-events-none disabled:opacity-30"
 >
