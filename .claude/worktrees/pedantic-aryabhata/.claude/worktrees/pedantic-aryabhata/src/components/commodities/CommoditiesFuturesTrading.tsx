...
function ContractExplorer({
 ...
 : "bg-muted/30 border-border text-muted-foreground hover:bg-muted/20"
 )}
 >
...
function CurveVisualizer({ initialContractId }: { initialContractId: string }) {
 ...
 className="bg-card border border-border rounded-md px-3 py-1.5 text-xs text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
 >
...
function SpreadTrading() {
 ...
 className="w-full bg-muted/30 border border-border rounded-md px-2.5 py-1.5 text-sm font-medium tabular-nums focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
 />
...
function OrderEntrySimulator() {
 ...
 className="w-full bg-muted/30 border border-border rounded-md px-3 py-1.5 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
 >
 {(["energy", "metals", "grains", "softs", "livestock"] as Sector[]).map((sec) => (
 <optgroup key={sec} label={SECTOR_LABELS[sec]}>
 {ALL_GENERATED.filter((x) => x.sector === sec).map((x) => (
 ...
 className="w-full bg-muted/30 border border-border rounded-md px-3 py-1.5 text-sm tabular-nums focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
 />
 </div>
 ...
 <div className="space-y-3">
 {/* Contract specs */}
 <div className="p-2.5 rounded-md bg-muted/20 border border-border space-y-1.5">
 ...
 <div key={label} className="flex justify-between items-center text-xs border-b border-border pb-1.5 last:border-0 last:pb-0">
 <span className="text-muted-foreground">{label}</span>
...
function StorageCarryAnalysis() {
 ...
 max={max}
 onChange={(e) => set(parseFloat(e.target.value) || 0)}
 className="w-full bg-muted/30 border border-border rounded-md px-2 py-1.5 text-sm tabular-nums focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
 />
 </div>
 ))}
 </div>
 ...
 Math.abs(basisPct) < 0.5 ? "bg-muted/20 border-border" :
 ...
 className="bg-card border border-border rounded-md px-2 py-1 text-xs focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
 >
 {(["energy", "metals", "grains", "softs", "livestock"] as Sector[]).map((sec) => (
 <optgroup key={sec} label={SECTOR_LABELS[sec]}>
 {ALL_GENERATED.filter((x) => x.sector === sec).map((x) => (
...
export default function CommoditiesFuturesTrading() {
 ...
 section === id
 ? "bg-primary/20 border-primary/40 text-primary"
 : "bg-muted/30 border-border text-muted-foreground hover:bg-muted/20 hover:text-foreground"
 )}
 >
