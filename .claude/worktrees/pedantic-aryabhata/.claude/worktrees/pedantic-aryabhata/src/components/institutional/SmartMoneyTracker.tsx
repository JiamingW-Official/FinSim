...
function GuroPicks() {
 ...
 return (
 <div key={guru.name} className="rounded-lg border border-border bg-card overflow-hidden">
 <button
...
function CongressTracker() {
 ...
 {/* Sector breakdown */}
 <div className="rounded-lg border border-border bg-card p-4 flex flex-col sm:flex-row items-start gap-4">
