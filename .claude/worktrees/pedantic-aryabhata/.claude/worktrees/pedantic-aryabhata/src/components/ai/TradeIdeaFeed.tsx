...
function DirectionBadge({ direction }: { direction: TradeIdea["direction"] }) {
 ...
 return (
 <span className="inline-flex items-center gap-0.5 rounded border border-border bg-muted px-1.5 py-0.5 text-[11px] font-semibold text-muted-foreground leading-none">
...
function IdeaCard({
 ...
 : "border-border bg-muted text-muted-foreground hover:bg-muted/30",
 )}
 >
 Trade This
