...
function ToggleRow({
 ...
 className={cn(
 "px-2.5 py-1 border-l border-border transition-colors duration-150",
 value === optionB
 ? "bg-primary/15 text-primary font-medium"
 : "bg-card text-muted-foreground hover:bg-muted/30 hover:text-foreground",
 )}
...
export function ThemeCustomizer({ open, onClose }: ThemeCustomizerProps) {
 ...
 {/* Swatch circle */}
 <div
 className="relative h-12 w-12 rounded-full border border-border flex items-center justify-center"
 ...
 {/* Live preview */}
 <div className="mt-4 rounded-md border border-border bg-background/60 p-3 space-y-1">
 <p
 className="font-semibold text-foreground transition-[font-size] duration-200"
 ...
 <p
 className="font-mono text-primary transition-[font-size] duration-200"
 ...
 className="w-full rounded-md border border-border bg-background/50 py-1.5 text-xs text-muted-foreground transition-colors hover:bg-muted/30 hover:text-foreground"
 >
 Reset to defaults
 </button>
 </div>
