...
export default function MonteCarloPanelV2({ result, startingCapital }: MonteCarloPanelV2Props) {
 ...
 className="flex items-center gap-1.5 rounded-md border border-border bg-muted/20 px-2 py-1 text-xs text-muted-foreground transition-colors hover:bg-muted/50"
 >
 ...
 return (
 <div key={pct} className="rounded-lg border border-border bg-muted/20 p-2 text-center">
...
function ParamInput({ label, value, onChange, min, max, step }: {
 ...
 className="w-full rounded-md border border-border bg-card px-2 py-1 text-xs text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
 />
 </div>
 );
}
