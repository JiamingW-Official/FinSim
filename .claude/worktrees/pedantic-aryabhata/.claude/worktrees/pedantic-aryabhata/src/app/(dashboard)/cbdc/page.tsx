...
function FundamentalsTab() {
 ...
 <tr key={attr} className={cn("border-b border-border", i % 2 === 0 ? "bg-foreground/[0.02]" : "")}>
 ...
 <div key={choice.dimension} className="border border-border rounded-lg overflow-hidden">
 <button
...
function CrossBorderTab() {
 ...
 <tr key={dim as string} className="border-b border-border hover:bg-muted/30 transition-colors">
