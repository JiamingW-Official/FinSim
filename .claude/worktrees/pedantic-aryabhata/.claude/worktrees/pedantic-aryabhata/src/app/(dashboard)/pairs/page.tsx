...
export default function PairsPage() {
 ...
 {/* Header */}
 <div className="flex items-center gap-3 px-6 py-6 border-b border-border border-l-4 border-l-primary shrink-0">
 ...
 Trading: <span className="text-foreground font-medium">{tickerA} / {tickerB}</span>
 </div>
 <button
 ...
 canEnter
 ? "bg-primary text-foreground-foreground hover:bg-primary/90"
