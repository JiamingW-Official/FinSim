...
function StatCard({
 ...
 return (
 <div className="rounded-md border border-border bg-foreground/[0.04] p-4 space-y-1">
...
function ILCalculator() {
 ...
 <div className="text-lg font-medium text-primary">${hodlValue.toFixed(1)}</div>
 </div>
 <div className="rounded-lg bg-foreground/5 p-3">
 <div className="text-xs text-muted-foreground mb-1">LP Value</div>
 <div className="text-lg font-medium text-primary">${lpValue.toFixed(1)}</div>
 </div>
 </div>
...
export default function CryptoPortfolioPage() {
 ...
 <tbody>
 {portfolioData.assets.map(a => (
 <tr key={a.symbol} className="border-b border-border hover:bg-muted/30 transition-colors">
 ...
 <div className="rounded-md border border-border bg-foreground/[0.04] p-4 space-y-4">
 ...
 <div key={row.m} className={cn("rounded-lg p-3 border", costMethod === row.m ? "border-primary bg-muted/10" : "border-border bg-foreground/[0.04]")}>
 ...
 <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
 {/* BTC Dominance Gauge */}
 <div className="rounded-md border border-border bg-foreground/[0.04] p-4 space-y-3">
 ...
 <div key={row.label} className="rounded-lg bg-foreground/5 p-2 text-center">
 ...
 <div key={chart.label} className="rounded-md border border-border bg-foreground/[0.04] p-4 space-y-2">
 ...
 <div key={r.title} className={cn("rounded-md border p-3 space-y-2", r.color)}>
 ...
 <div key={row.type} className="rounded-lg bg-foreground/5 p-3">
 ...
 return (
 <div key={sc.event} className={cn("rounded-md border p-3 space-y-2", sc.color)}>
 ...
 <span className="text-red-400 font-medium">{sc.impact}%</span>
 ...
 <div key={m.method} className="rounded-md border border-border bg-foreground/5 p-4 space-y-3">
 ...
 <tr key={r.bracket} className="border-b border-border">
 ...
 <td className={cn("py-2 text-xs font-medium", row.term === "L" ? "text-primary" : "text-orange-400")}>
 {row.term === "L" ? "LT" : "ST"}
 </td>
 </tr>
 );
