...
export default function TokenizationPage() {
 ...
 <div key={item.step} className="p-3 rounded-lg bg-muted/50 border border-border">
 ...
 <div key={r.title} className="p-3 rounded-lg bg-muted/40 border border-border">
 ...
 <div key={row.label} className="flex justify-between text-xs text-muted-foreground border-b border-border py-1">
 ...
 <div key={proto.name} className="p-3 rounded-lg bg-muted/40 border border-border space-y-2">
 ...
 <div key={jur.name} className="p-3 rounded-lg bg-muted/40 border border-border">
 ...
 <div key={item.entity} className="p-2 rounded bg-muted/40 border border-border text-xs text-muted-foreground">
 ...
 <div key={item.cat} className="p-2 rounded bg-muted/40 border border-border text-xs text-muted-foreground">
 ...
 <div key={inst.name} className="p-3 rounded-lg bg-muted/40 border border-border">
 <div className="flex justify-between items-start mb-1">
 ...
 <div key={item.title} className="flex items-start gap-2 p-3 rounded-lg bg-muted/40 border border-border">
