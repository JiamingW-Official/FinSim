...
export default function OptimizationPanel({ savedStrategies }: Props) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-lg border border-border bg-muted/10 p-4 space-y-3">
        ...
        <div className="flex items-center gap-3">
          ...
          <select
            ...
            className="flex-1 appearance-none rounded-md border border-border bg-card px-2 py-1.5 text-xs text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
          >
      ...
      {!hasRun && (
        <div className="flex h-32 items-center justify-center rounded-lg border border-border bg-muted/5 text-sm text-muted-foreground/70">
