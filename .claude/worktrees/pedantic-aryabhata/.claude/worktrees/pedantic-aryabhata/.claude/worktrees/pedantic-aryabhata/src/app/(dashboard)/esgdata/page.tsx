...
function ProviderComparisonTable() {
 ...
 <td className="px-4 py-3">
 <span className="text-foreground font-medium">{p.sWeight}%</span>
 </td>
 <td className="px-4 py-3">
...
function ESGWeightBarChart() {
 ...
 <div style={{ width: `${p.eWeight}%`, background: "#10b981" }} className="flex items-center justify-center text-[11px] text-foreground font-semibold">
 {p.eWeight}
 </div>
 <div style={{ width: `${p.sWeight}%`, background: "#3b82f6" }} className="flex items-center justify-center text-[11px] text-foreground font-semibold">
 {p.sWeight}
 </div>
...
function DoubleMaterialityCard() {
 ...
 <div className="flex-1 rounded-lg bg-muted/10 border border-border p-3">
 <div className="text-xs font-medium text-foreground mb-1">Financial Materiality</div>
 <p className="text-xs text-muted-foreground">
 ...
 { label: "SFDR Art. 8", desc: "Promotes E/S characteristics", color: "bg-muted/10 text-foreground" },
...
function ImpactVsESGWashing() {
 ...
 <div className="text-xs font-medium text-foreground mb-2">ESG Washing</div>
...
function ActiveOwnershipCard() {
 ...
 <div className="text-2xl font-semibold" style={{ color: st.color }}>
 {st.value}
 </div>
...
export default function ESGDataPage() {
 ...
 { value: "greenwashing", label: "Greenwashing & Quality" },
 { value: "integration", label: "ESG Integration" },
 ].map((tab) => (
 <TabsTrigger
 key={tab.value}
 value={tab.value}
 ...
 <div className="rounded-lg bg-muted/10 border border-border p-3">
 <div className="font-medium text-foreground mb-1">Limited Assurance</div>
 ...
 <div className="rounded bg-muted/10 border border-border p-2">
