        ...
        {phase === "searching" && (
          ...
          >
            ...
            <div className="text-center">
              ...
              <p className="text-[10px] text-muted-foreground/60 mt-0.5">{config.name} · {config.timeLimitSeconds}s</p>
            </div>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="flex items-center gap-1.5 rounded-lg border border-border bg-muted/30 px-4 py-2 text-xs text-muted-foreground transition-colors hover:bg-muted/50 hover:text-foreground"
            >
              <X className="h-3 w-3" />
              Cancel
              <span className="text-[9px] text-muted-foreground/60 ml-1">(Esc)</span>
            </motion.button>
          </motion.div>
        )}
