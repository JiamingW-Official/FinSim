        ...
        <div className="absolute left-3 top-3 z-10 flex items-center gap-2">
          ...
          {onRegenerate && (
            <button
              ...
              className="flex h-7 w-7 items-center justify-center rounded-lg border border-border bg-card/90 text-muted-foreground backdrop-blur transition-colors hover:bg-primary/20 hover:text-primary"
            >
