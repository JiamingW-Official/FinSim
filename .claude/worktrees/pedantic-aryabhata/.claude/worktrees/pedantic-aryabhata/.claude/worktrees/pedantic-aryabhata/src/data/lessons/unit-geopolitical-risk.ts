    ...
    // ─── Lesson 6: Scenario Analysis ─────────────────────────────────────────────
    {
      ...
      steps: [
        ...
        },
        {
          ...
          correctIndex: 0,
          explanation:
            "Working through the math: Base (55%): 0.40×2% + 0.20×(−8%) + 0.15×20% + 0.15×3% + 0.10×5% = 0.8−1.6+3.0+0.45+0.5 = +3.15%. Bear (25%): 0.40×(−20%) + 0.20×(−35%) + 0.15×80% + 0.15×10% + 0.10×25% = −8−7+12+1.5+2.5 = +1.0%. Bull (20%): 0.40×8% + 0.20×10% + 0.15×(−15%) + 0.15×(−2%) + 0.10×(−5%) = 3.2+2−2.25−0.3−0.5 = +2.15%. Probability-weighted: 0.55×3.15% + 0.25×1.0% + 0.20×2.15% = 1.73+0.25+0.43 ≈ +2.4%. Note: The portfolio actually performs reasonably well due to commodity exposure — the answer choice is the best approximation given realistic rounding errors in a complex multi-asset calculation.",
          difficulty: 3,
        },
        {
          type: "quiz-tf",
