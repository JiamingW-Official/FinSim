                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {[
                      ...
                      <div key={label} className={cn("rounded-md border p-3",
                        highlight ? "border-primary/30 bg-muted/5" : "border-border bg-muted/20")}>
                  ...
                  {bonds.map(b => {
                    ...
                    return (
                      <div key={b.id} className={cn(
                        ...
                        inPortfolio ? "border-primary/40 bg-muted/5" : "border-border bg-card hover:bg-muted/20",
                      )}>
                        <div className="flex items-center gap-2">
                      ...
                      <table className="w-full text-xs text-muted-foreground">
                        ...
                        <tbody>
                          {portfolio.map(h => {
                            ...
                            return (
                              <tr key={h.bondId} className="border-b border-border hover:bg-muted/10">
                                ...
                                <td className="px-3 py-2.5">
                                  <input
                                    ...
                                    className="w-16 rounded border border-border bg-background px-1.5 py-0.5 text-xs text-foreground focus:border-primary focus:outline-none"
                                  />
                                </td>
                  ...
                  >
                    ...
                    <div className="grid grid-cols-2 gap-1.5 text-[11px]">
                      {[
                        ...
                        <div key={m.label} className="rounded border border-border bg-muted/20 px-2 py-1.5">
