      ...
      {show && (
        ...
        >
          <motion.div
            ...
            className="relative w-[420px] overflow-hidden rounded-md border border-border bg-card"
            ...
            <div className="px-5 pb-5 space-y-3">
              ...
              >
                {claimed ? (
                  ...
                  <div className="flex items-center justify-center gap-2 rounded-md border border-border bg-muted/10 px-5 py-3">
                    <Check className="h-4 w-4 text-emerald-400" />
