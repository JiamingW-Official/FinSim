...
function MatchCard({ match }: { match: BracketMatch }) {
  return (
    <div className="rounded-lg border border-border bg-muted/10 overflow-hidden text-[11px]">
    ...
    <div className="space-y-5 pb-4">
      ...
      {!joined ? (
        ...
        <button
          type="button"
          onClick={handleReset}
          className="w-full flex items-center justify-center gap-2 rounded-lg border border-border bg-muted/20 py-2.5 text-sm font-semibold text-muted-foreground transition-colors hover:bg-muted/50"
        >
          New Tournament
        </button>
      )}
