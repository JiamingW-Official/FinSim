            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {BRACKETS.map((b) => {
                  ...
                  const diff = t - base;
                  return (
                    <tr key={b} className={cn("border-b border-border", b === targetBracket && "bg-indigo-500/10")}>
          ...
          <CardContent>
            <div className="space-y-3">
              {[
                ...
                <div key={`rs-${i}`} className="p-3 rounded-lg bg-muted/50 border border-border">
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {STATE_FISCAL.map((st, i) => (
                  <tr key={`sf-${i}`} className="border-b border-border">
