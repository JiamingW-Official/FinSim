...
function MarketRow({
  ...
  return (
    <button
      ...
      className="group flex w-full flex-col gap-1.5 rounded-lg px-3 py-3 text-left cursor-pointer hover:bg-foreground/[0.02] transition-colors duration-150"
    >
      ...
      <div className="flex items-center gap-2 pl-[18px]">
        <div className="flex-1 h-[2px] rounded-full bg-border overflow-hidden">
          <div
            className="h-full rounded-full bg-emerald-500/40 transition-all duration-300"
            style={{ width: `${prob}%` }}
          />
        </div>
      ...
      <div className="border-b border-border px-5 pt-6 pb-0">
        <div className="flex items-center gap-3 pb-4">
          <div className="min-w-0">
            <p className="text-[10px] uppercase tracking-widest text-muted-foreground/40 mb-1">Forecasting</p>
            <h1 className="font-serif text-3xl font-light tracking-tight">Prediction Markets</h1>
            <p className="text-xs text-muted-foreground/60 leading-relaxed mt-1">
              {PREDICTION_MARKETS.length} markets &middot; <span className="font-mono tabular-nums">{insightPoints.toLocaleString()}</span> pts available
            </p>
          </div>
        ...
        <div className="border-b border-border px-5 py-4">
          <div className="flex items-center gap-4">
            ...
            <div className="shrink-0 text-right">
              <p className="text-[10px] uppercase tracking-widest text-muted-foreground/40 mb-1">Points</p>
              <p className="font-serif text-2xl tabular-nums">{insightPoints.toLocaleString()}</p>
            </div>
          </div>
        </div>
      )}
