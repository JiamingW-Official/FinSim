...
export const CATEGORY_INFO: Record<string, { label: string; color: string; bgColor: string }> = {
  "trend-following": { label: "Trend Following", color: "text-primary", bgColor: "bg-primary/10" },
  "mean-reversion": { label: "Mean Reversion", color: "text-muted-foreground", bgColor: "bg-muted" },
