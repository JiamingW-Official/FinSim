...
const jsonLd = {
  ...
  offers: {
    ...
    price: "0",
    priceCurrency: "USD",
    description: "Free to start — full simulator access with no account required.",
  },
  featureList: [
    "Paper Trading with $100K virtual capital",
    "Options chain simulator with Greeks",
    "Black-Scholes pricing and volatility smile",
    "AI Trading Coach with 50+ signals",
    "Prediction market training",
    "Quant backtesting lab",
    "Interactive lessons and flashcards",
