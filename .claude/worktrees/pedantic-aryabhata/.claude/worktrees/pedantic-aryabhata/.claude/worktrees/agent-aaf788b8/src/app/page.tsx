  ...
  return (
    <div className="relative min-h-screen bg-background">
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 pt-12 sm:pt-20 pb-16 sm:pb-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative hidden lg:block">
            <div className="rounded-lg border border-border/40 bg-card/80 overflow-hidden shadow-sm shadow-black/20">
              {/* Title bar */}
            ...
            <div className="absolute -bottom-4 -left-6 rounded-lg border border-border/40 bg-card p-3 shadow-sm shadow-black/20">
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-px bg-border/20 rounded-lg overflow-hidden border border-border/40">
          {FEATURES.map((f, i) => (
            <div
              key={f.title}
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 pt-16 pb-10">
        <div className="rounded-lg border border-border/40 bg-card/50 p-6 sm:p-10 text-center">
