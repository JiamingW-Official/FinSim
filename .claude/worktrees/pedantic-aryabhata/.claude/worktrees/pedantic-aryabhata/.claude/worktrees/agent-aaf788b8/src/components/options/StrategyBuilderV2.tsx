...
const SENTIMENTS: {
  ...
  },
  {
    value: "neutral",
    label: "Neutral",
    activeClass: "bg-muted/30 border-border text-foreground/80",
    icon: "→",
  },
  {
    value: "directional",
    ...
    <div className="flex flex-col h-full overflow-hidden">
      ...
      {sentiment === null ? (
        ...
        <div className="flex flex-1 flex-col items-center justify-center gap-1">
          ...
          <p className="text-[9px] text-muted-foreground/60">Try a different sentiment or check back with more chain data</p>
        </div>
      ) : (
