...
export function PnLCalendar({ trades }: Props) {
  ...
  function getCellStyle(summary: DaySummary | undefined): string {
    if (!summary || summary.tradeCount === 0) return "bg-card border-border";
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex items-center justify-between">
        <button
          onClick={prevMonth}
          className="flex h-7 w-7 items-center justify-center rounded-md border border-border text-muted-foreground transition-colors hover:bg-muted/30 hover:text-foreground"
        >
      ...
      {hoveredSummary && hoveredSummary.tradeCount > 0 ? (
        ...
        <div className="rounded-lg border border-border bg-card/30 px-2.5 py-2 text-xs text-muted-foreground/50 text-center">
      ...
      <div className="flex items-center gap-3 justify-end">
        ...
        <div className="flex items-center gap-1 text-[11px] text-muted-foreground">
          <div className="h-2 w-2 rounded-sm bg-card border border-border" />
          No trades
        </div>
        <div className="flex items-center gap-1 text-[11px] text-muted-foreground">
