  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="flex items-center gap-3 border-b border-border px-4 py-2">
        ...
        <div>
          <h1 className="text-sm font-serif font-medium tracking-tight text-foreground">Strategy Backtester</h1>
          <p className="text-[10px] text-muted-foreground leading-relaxed">Build, test, and optimize on simulated market data</p>
        </div>
