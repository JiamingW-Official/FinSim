          ...
          >
            ...
            <div className="flex items-center gap-2.5 mb-4">
              <div className={cn(
                ...
                isChainComplete ? "bg-green-500/15 text-green-400" : "bg-muted/30",
                chain.color,
              )}>
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="mt-1 h-1 w-full overflow-hidden rounded-full bg-muted/30">
                  <motion.div
                    className={cn(
                      "h-full rounded-full",
                      isChainComplete ? "bg-green-500" : "bg-muted/80",
                    )}
                    initial={{ width: 0 }}
              ...
              <span className={cn(
                ...
                isChainComplete ? "text-green-400" : "text-muted-foreground/60",
              )}>
                      ...
                      <motion.button
                        ...
                        className={cn(
                          ...
                          isClaimed
                            ...
                            : isComplete
                              ? "border-violet-500 bg-violet-500/20 text-violet-300 shadow-sm shadow-violet-500/20 animate-pulse"
                              : isLocked
