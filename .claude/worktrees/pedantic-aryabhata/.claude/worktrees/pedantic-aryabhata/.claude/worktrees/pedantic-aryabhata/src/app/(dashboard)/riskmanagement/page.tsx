    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          <div className="bg-muted/60 rounded-md p-3 border border-border text-center">
            <GaugeSVG
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        ...
        <div className="bg-muted/60 rounded-md p-6 border border-border border-l-4 border-l-primary">
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {[
                ...
                <tr key={row.model} className="border-b border-border hover:bg-muted/20">
          ...
          <div className="bg-muted/60 rounded-md p-4 border border-border">
            ...
            <div className="space-y-2 text-xs text-muted-foreground">
              {[
                ...
                <div key={row.label} className="flex justify-between py-1 border-b border-border">
