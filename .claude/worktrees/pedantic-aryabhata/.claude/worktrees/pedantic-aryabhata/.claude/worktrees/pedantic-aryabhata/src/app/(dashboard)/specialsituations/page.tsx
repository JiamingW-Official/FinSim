      ...
      <div className="bg-card border border-border rounded-md p-5">
        ...
        <div className="space-y-2">
          {targetCriteria.map(({ criterion, weight, detail }) => (
            <div key={criterion} className="flex items-start gap-3 py-2 border-b border-border last:border-0">
              <span
                className={cn(
      ...
      <div className="bg-card border border-border rounded-md p-5">
        ...
        <div className="space-y-2">
          {riskFactors.map(({ risk, detail }) => (
            <div key={risk} className="flex items-start gap-3 py-2 border-b border-border last:border-0">
