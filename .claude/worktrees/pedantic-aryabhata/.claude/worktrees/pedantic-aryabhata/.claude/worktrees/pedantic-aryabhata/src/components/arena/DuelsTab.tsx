...
function DuelResults({ yourPnl, oppPnl, yourTrades, opponent, mode, eloChange, eloBefore, eloAfter, onRematch, onFindNew }: DuelResultsProps) {
  ...
  return (
    ...
    >
      ...
      {/* ELO change */}
      <div className="flex items-center gap-3 rounded-lg border border-border bg-muted/10 px-4 py-2">
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          type="button"
          onClick={onFindNew}
          className="flex items-center gap-2 rounded-lg border border-border bg-muted/20 px-5 py-2.5 text-sm font-semibold text-muted-foreground transition-colors hover:bg-muted/50"
        >
