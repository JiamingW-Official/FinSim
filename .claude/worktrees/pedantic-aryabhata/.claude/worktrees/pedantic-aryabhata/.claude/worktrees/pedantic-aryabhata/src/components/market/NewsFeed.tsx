            ...
            <div>
              ...
              <div className="flex flex-wrap gap-1.5">
                {item.relatedTickers.map((t) => (
                  <span
                    key={t}
                    className="text-[11px] font-semibold px-2 py-1 rounded bg-accent/30 text-foreground border border-border"
                  >
                    {t}
                  </span>
                ))}
              ...
              <button
                ...
                className={cn(
                  ...
                  t === ticker
                    ...
                    : "bg-muted/20 border-border text-foreground hover:border-border hover:bg-muted/30"
                )}
              >
                {t}
      ...
      <div className="space-y-1">
        ...
        {filteredItems.map((item) => (
          <button
            ...
            className="w-full text-left border border-border rounded-lg bg-card p-3 flex items-start gap-3 hover:border-border hover:bg-muted/10 transition-colors"
          >
