    ...
    <div className="flex h-full flex-col">
      ...
      <div className="border-b border-border px-4 py-4">
        <div className="flex items-center gap-3">
          <motion.div
            className="flex h-10 w-10 items-center justify-center rounded-lg bg-cyan-500/10"
        ...
        <div className="flex items-center gap-2 mt-3">
          <motion.div
            className="flex items-center gap-1.5 rounded-lg border border-border/50 bg-muted/10 px-3 py-1.5"
