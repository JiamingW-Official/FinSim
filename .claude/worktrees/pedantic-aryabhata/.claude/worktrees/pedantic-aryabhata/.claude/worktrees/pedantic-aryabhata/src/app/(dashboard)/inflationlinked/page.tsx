...
function SectionCard({ title, children, icon: Icon }: { title: string; children: React.ReactNode; icon?: React.ElementType }) {
  return (
    <div className="rounded-md border border-border bg-foreground/[0.03] p-4">
      {title && (
          ...
          <table className="w-full text-xs text-muted-foreground">
            ...
            <tbody>
              {GLOBAL_LINKER_MARKETS.map((m) => (
                <tr key={m.country} className="border-b border-border hover:bg-muted/30 transition-colors">
  ...
  return (
    <div className="space-y-5">
      ...
      <SectionCard title="Breakeven Inflation & Fisher Equation" icon={Calculator}>
        ...
        <div className="p-3 rounded bg-foreground/[0.04] border border-border space-y-1.5 text-xs text-muted-foreground">
  ...
  return (
    <div className="space-y-5">
      ...
      <SectionCard title="TIPS Duration Calculator" icon={Calculator}>
        ...
        <div className="mt-3 p-3 rounded bg-foreground/[0.04] border border-border text-xs text-muted-foreground space-y-1">
          ...
          <table className="w-full text-xs text-muted-foreground">
            ...
            <tbody>
              {INFLATION_BETA_TABLE.map((row) => (
                <tr key={row.asset} className="border-b border-border hover:bg-muted/30 transition-colors">
        ...
        <AnimatePresence mode="wait">
          ...
          >
            {[
              ...
              return (
                <div key={key} className="rounded-lg border border-border bg-foreground/[0.03] p-2 text-center">
