  ...
  return (
    <svg viewBox="0 0 200 110" className="w-full max-w-[280px] mx-auto">
      ...
      <text
        ...
        y={cy - 20}
        textAnchor="middle"
        className="fill-foreground font-mono tabular-nums text-3xl font-bold"
        fontSize="28"
  ...
  return (
    <div className="space-y-1">
      <div className="flex items-center justify-between">
        ...
        <span className="font-mono tabular-nums text-xs font-medium">{value.toFixed(0)}</span>
      </div>
      ...
      <div className="flex items-center justify-between">
        ...
        <span
          className={cn(
            ...
            sentiment.level === "greed" && "bg-green-500/10 text-green-500",
