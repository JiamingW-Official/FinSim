  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.div
          className={cn(
            "relative flex h-24 w-24 items-center justify-center rounded-lg border-2 text-5xl font-black",
            config.border,
            config.bg,
            config.color,
        ...
        <motion.button
          ...
          className="w-full rounded-lg bg-primary py-3.5 text-sm font-bold text-primary-foreground transition-all hover:brightness-110 shadow-[0_0_20px_rgba(16,185,129,0.2)]"
        >
          Continue 🚀
        </motion.button>
      </motion.div>
