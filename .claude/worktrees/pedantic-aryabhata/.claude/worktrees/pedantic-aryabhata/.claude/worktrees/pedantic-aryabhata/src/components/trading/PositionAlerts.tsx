      ...
      for (const threshold of profitMilestones) {
        if (pct >= threshold) {
          ...
          if (!alertedProfit.current.has(key)) {
            ...
            toast.custom(
              () => (
                <div className="flex items-center gap-2 rounded-lg border border-emerald-500/30 bg-card px-3 py-2 text-[11px] max-w-64">
      ...
      if (atrValue !== null && atrValue > 0) {
        ...
        if (distToPct <= 0.5) {
          ...
          if (!alertedAtrStop.current.has(key)) {
            ...
            toast.custom(
              () => (
                <div className="flex items-center gap-2 rounded-lg border border-amber-500/30 bg-card px-3 py-2 text-[11px] max-w-64">
      ...
      if (pos.openedAtTimestamp) {
        ...
        if (barsHeld > 20) {
          ...
          if (!alertedTimeExit.current.has(key)) {
            ...
            toast.custom(
              () => (
                <div className="flex items-center gap-2 rounded-lg border border-border bg-card px-3 py-2 text-[11px] max-w-64">
