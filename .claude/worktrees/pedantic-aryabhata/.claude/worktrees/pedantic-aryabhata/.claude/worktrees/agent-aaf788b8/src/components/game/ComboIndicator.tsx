...
export function ComboIndicator() {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      setVisible(false);
      innerTimer = setTimeout(clearCombo, 300);
    }, 3000);
  ...
  return (
    <AnimatePresence>
      {visible && (
        ...
        >
          <div className="flex items-center gap-2 rounded-full border border-amber-500/40 bg-card/95 px-5 py-2.5 shadow-sm shadow-amber-500/10 backdrop-blur-sm">
