      ...
      {past.map((entry, i) => {
        ...
        return (
          <div
            ...
            className="flex items-center gap-1 rounded border border-border bg-muted/20 px-1.5 py-0.5"
          >
            <span
              className={cn(
...
export function ChartPatternAnnotations({
  ...
  return (
    <div className="border-t border-border bg-card/60 backdrop-blur-sm px-3 py-1.5 space-y-1">
