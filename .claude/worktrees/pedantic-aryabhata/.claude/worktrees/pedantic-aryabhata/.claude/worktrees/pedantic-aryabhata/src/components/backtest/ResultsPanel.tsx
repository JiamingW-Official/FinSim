...
const GRADE_CONFIG = {
  ...
  C: { color: "text-muted-foreground", bg: "bg-muted/50", border: "border-border" },
} as const;
  ...
  return (
    <div className="flex h-full flex-col bg-card">
          ...
          <div className="p-5 space-y-5">
            ...
            <div className="flex items-center gap-5">
              ...
              <div className={`flex flex-col items-center justify-center w-20 h-20 flex-shrink-0 border ${config.bg} ${config.border}`}>
                ...
                <div className="text-[10px] text-muted-foreground/60 uppercase tracking-widest mt-0.5">Grade</div>
              </div>
            ...
            <div className="grid grid-cols-4 gap-4 text-center">
              <div>
                <div className="text-[10px] text-muted-foreground/60 uppercase tracking-widest">Sharpe</div>
              ...
              <div>
                <div className="text-[10px] text-muted-foreground/60 uppercase tracking-widest">Win Rate</div>
                <div className="text-sm font-semibold font-mono tabular-nums tracking-tight text-foreground">{metrics.winRate.toFixed(0)}%</div>
              </div>
              <div>
                <div className="text-[10px] text-muted-foreground/60 uppercase tracking-widest">Max DD</div>
              ...
              <div>
                <div className="text-[10px] text-muted-foreground/60 uppercase tracking-widest">Trades</div>
            ...
            {/* Disclaimer */}
            <p className="text-center text-[10px] text-muted-foreground/60 uppercase tracking-widest/70">
      ...
      <div className="flex gap-2 border-t border-border p-2.5">
        <button onClick={onSave} className="flex flex-1 items-center justify-center gap-1.5 border border-border py-1.5 text-xs font-medium text-foreground transition-colors hover:bg-muted/50">
          <Save className="h-3 w-3" /> Save
        </button>
        <button onClick={onRerun} className="flex flex-1 items-center justify-center gap-1.5 border border-border py-1.5 text-xs font-medium text-foreground transition-colors hover:bg-muted/50">
...
function CompactMetric({ label, value, positive }: { label: string; value: string; positive?: boolean }) {
  return (
    <div className="border border-border px-3 py-2">
      <div className="text-[10px] text-muted-foreground/60 uppercase tracking-widest">{label}</div>
