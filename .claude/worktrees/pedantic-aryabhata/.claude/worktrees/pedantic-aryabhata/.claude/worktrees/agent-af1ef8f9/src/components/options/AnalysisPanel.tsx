  ...
  return (
    <div className="flex flex-col rounded-lg border border-border/50 bg-card hover:border-border/60 transition-colors">
      ...
      <div className="flex-1">
        <svg viewBox="0 0 300 120" className="w-full" aria-hidden="true" role="img">
          {/* Y gridlines */}
          {gridLines.map((pct) => {
...
function HorizontalStrikeChart({
    ...
    return (
      <div className="flex flex-col rounded-lg border border-border/50 bg-card hover:border-border/60 transition-colors">
        ...
        <div className="flex flex-1 flex-col items-center justify-center gap-1 py-8">
          <span className="text-[10px] text-muted-foreground">No option chain data available</span>
          <span className="text-[9px] text-muted-foreground/60">Select an expiry with open interest</span>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="flex flex-col rounded-lg border border-border/50 bg-card hover:border-border/60 transition-colors">
      <CardTitle title={title} subtitle={subtitle} />
      <div className="flex-1">
        <svg viewBox={`0 0 ${svgW} ${svgH}`} className="w-full" aria-hidden="true" role="img">
          {/* Header labels */}
  ...
  if (smile.length === 0) {
    return (
      <div className="flex flex-col rounded-lg border border-border/50 bg-card hover:border-border/60 transition-colors">
        ...
        <div className="flex flex-1 flex-col items-center justify-center gap-1 py-8">
          <span className="text-[10px] text-muted-foreground">No volatility smile data</span>
          <span className="text-[9px] text-muted-foreground/60">Requires option chain with IV data</span>
        </div>
      </div>
    );
  }
  ...
  if (termStructure.length === 0) {
    return (
      <div className="flex flex-col rounded-lg border border-border/50 bg-card hover:border-border/60 transition-colors">
        ...
        <div className="flex flex-1 flex-col items-center justify-center gap-1 py-8">
          <span className="text-[10px] text-muted-foreground">No term structure data</span>
          <span className="text-[9px] text-muted-foreground/60">Requires multiple expiry dates</span>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className={cn("overflow-auto p-3")}>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        {/* Chart 7: 3D Volatility Surface — full width */}
        <div className="sm:col-span-2">
          <VolSurface3D baseIV={analytics.atmIV} spotPrice={spotPrice} />
        </div>
      </div>
    </div>
  );
