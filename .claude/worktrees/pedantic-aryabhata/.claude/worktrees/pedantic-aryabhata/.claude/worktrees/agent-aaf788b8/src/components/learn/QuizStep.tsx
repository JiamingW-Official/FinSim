  ...
  return (
    <div className="flex flex-col gap-4">
      {step.type === "quiz-scenario" && (
        <motion.div
          className="rounded-lg bg-amber-500/8 border border-amber-500/20 p-3.5"
        ...
        {options.map((opt, i) => {
          ...
          return (
            <motion.button
              ...
              className={cn(
                "relative rounded-lg border-2 p-3.5 text-left text-sm font-medium transition-colors",
            ...
            >
              <span className={cn(
                ...
                showResult && isThis && isCorrect ? "bg-green-500/30 text-green-300"
                  : showResult && isThis && !isCorrect ? "bg-red-500/30 text-red-300"
                  : showResult && isRight ? "bg-green-500/20 text-green-400/80"
              ...
              <AnimatePresence>
                {showResult && isThis && isCorrect && (
                  <motion.span
                    ...
                    className="absolute right-3 top-1/2 -translate-y-1/2 text-green-400 text-xl"
                  >
                    ✓
                  </motion.span>
                )}
      ...
      <AnimatePresence>
        {showResult && (
          <motion.div
            ...
            className={cn(
              "overflow-hidden rounded-lg border-l-4 p-3.5",
              isCorrect
                ? "border-l-green-500 border-green-500/20 bg-green-500/5"
      ...
      {showResult && (
        <motion.button
          ...
          className={cn(
            ...
            isCorrect
              ? "bg-green-500 text-white hover:bg-green-400 shadow-[0_0_20px_rgba(16,185,129,0.25)]"
