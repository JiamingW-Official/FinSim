    ...
    // ─── Lesson 1: Time Value of Money ───────────────────────────────────────
    {
      ...
      steps: [
        ...
        },
        {
          ...
          correctIndex: 1,
          explanation:
            "Rule of 72: years to double ≈ 72 / 9 = 8 years. Exact answer using FV formula: 5,000 × (1.09)ⁿ = 10,000 → (1.09)ⁿ = 2 → n = ln(2)/ln(1.09) = 8.04 years. The Rule of 72 gives a very close approximation.",
          difficulty: 1,
        },
        {
          type: "quiz-scenario",
