  ...
  return (
    ...
    >
      <motion.div
        ...
        className="relative max-h-[85vh] w-full max-w-5xl overflow-hidden rounded-md border border-border bg-card/95"
      ...
      >
        ...
        <div className="flex h-[calc(85vh-64px)] overflow-hidden">
          {/* Left: Card Grid */}
          <div className="w-[400px] space-y-2 overflow-y-auto border-r border-border p-4">
              ...
              {selected ? (
                ...
                >
                  ...
                  <button
                    ...
                    className="w-full rounded-md bg-primary py-3 text-sm font-semibold text-foreground transition-colors hover:bg-primary"
                  >
                    Use This Strategy
                  </button>
                </motion.div>
