      ...
      <table className="w-full text-sm">
        ...
        <tbody>
          {sorted.map((row, i) => {
            ...
            return (
              <tr key={row.ticker} className={`border-b border-border hover:bg-muted/20 transition-colors ${i % 2 === 0 ? "" : "bg-muted/10"}`}>
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="space-y-2">
        ...
        {steps.map((st) => (
          <div key={st.step} className="flex items-center gap-3 p-3 rounded-lg bg-muted/20 border border-border">
              ...
              <Card className="bg-card border-border">
                ...
                <CardContent className="px-4 pb-4 grid grid-cols-1 md:grid-cols-2 gap-3">
                  {[
                    ...
                    <div key={section.dir} className="p-3 rounded-lg bg-muted/20 border border-border">
