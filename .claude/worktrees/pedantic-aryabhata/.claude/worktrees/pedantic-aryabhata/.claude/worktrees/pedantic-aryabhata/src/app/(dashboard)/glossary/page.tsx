    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
        {filtered.map((pattern) => {
          ...
          return (
            <div key={pattern.name} className="rounded-lg border border-border bg-card overflow-hidden">
              <button
  ...
  return (
    <div className="flex flex-col gap-3">
      {ECONOMIC_INDICATORS.map((ind) => {
        ...
        return (
          <div key={ind.name} className="rounded-lg border border-border bg-card overflow-hidden">
            <button
              className="w-full text-left p-3 flex items-start justify-between gap-2"
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1">
                      {ind.relatedIndicators.map((r) => (
                        <Badge key={r} className="text-xs bg-muted/50 text-muted-foreground border-border">
                          {r}
                        </Badge>
                      ))}
                    </div>
...
export default function GlossaryPage() {
  return (
    <div className="flex flex-col h-full min-h-0">
      {/* Header */}
      <div className="border-b border-border border-l-4 border-l-primary px-4 py-3 shrink-0">
