                ...
                <button
                  ...
                  className={`w-full text-left rounded-md border px-4 py-3 text-sm font-medium transition-all ${
                    variant === "correct"
                      ...
                      : "border-border bg-muted/30 hover:bg-muted/40 hover:border-border"
                  }`}
                >
  ...
  return (
    <div className="flex flex-col gap-4 max-w-xl mx-auto py-4">
      ...
      <div className="flex gap-3">
        <div className="flex-1 rounded-md border border-border bg-muted/20 px-3 py-2 text-center">
        ...
        <div className="relative" style={{ perspective: 1000 }}>
          ...
          >
            ...
            <div
              ...
              className="absolute inset-0 flex flex-col items-center justify-center rounded-md border border-border bg-card px-6 py-8 text-center"
            >
...
function DailyChallengeTab() {
  ...
  return (
    <div className="flex flex-col gap-5 max-w-xl mx-auto py-4">
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            {dailyQuestion.options?.map((opt, idx) => {
              let cls = "border-border bg-muted/30 hover:bg-muted/40 hover:border-border";
              if (revealed) {
                ...
                else cls = "border-border bg-transparent text-muted-foreground/40";
              }
      ...
      {/* Leaderboard */}
      <div className="rounded-md border border-border bg-muted/10 px-4 py-4">
  ...
  return (
    <div className="flex flex-col gap-5 max-w-xl mx-auto py-4">
      ...
      {quizSessions.length === 0 && overallTotal === 0 && (
        <div className="rounded-md border border-border bg-muted/10 p-8 text-center">
...
export default function QuizPage() {
  return (
    <div className="flex flex-col h-full overflow-hidden">
      {/* Page header */}
      <div className="shrink-0 border-b border-border border-l-4 border-l-primary px-6 py-6">
        <div className="flex items-center gap-3">
          <div>
