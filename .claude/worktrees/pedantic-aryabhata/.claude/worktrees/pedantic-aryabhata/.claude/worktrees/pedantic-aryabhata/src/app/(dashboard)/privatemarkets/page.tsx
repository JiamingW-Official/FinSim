  ...
  return (
    <div className="overflow-x-auto rounded-md border border-border">
      <table className="w-full text-xs text-muted-foreground">
        ...
        <tbody>
          {assets.map((a, i) => (
            <tr key={a.type} className={cn("border-b border-border", i % 2 === 0 ? "" : "bg-muted/10")}>
      ...
      <table className="w-full text-xs text-muted-foreground">
        ...
        <tbody>
          {HF_STRATEGIES.map((st, i) => (
            <tr
              key={st.name}
              className={cn("border-b border-border hover:bg-muted/20 transition-colors", i % 2 === 0 ? "" : "bg-muted/10")}
            >
          ...
          <div className="rounded-md border border-border bg-card p-5">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-xs text-muted-foreground">
                ...
                <tbody>
                  {VC_SECTORS.map((s, i) => (
                    <tr key={s.name} className={cn("border-b border-border", i % 2 === 0 ? "" : "bg-muted/10")}>
