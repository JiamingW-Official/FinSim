        ...
        {flipped && (
          ...
          >
            ...
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 rounded-xl border border-green-500/30 bg-green-500/10 py-3 text-sm font-bold text-green-400 transition-all hover:bg-green-500/20 active:scale-95"
            >
