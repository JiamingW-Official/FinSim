    ...
    <div className="flex flex-col gap-4">
      ...
      >
        <Link
          href="/trade"
          target="_blank"
          className="flex w-full items-center justify-center gap-2 rounded-lg border-2 border-primary bg-primary/10 py-3 text-sm font-bold text-primary transition-all hover:bg-primary/20 active:scale-[0.98]"
        >
      ...
      {!done && (
        <motion.button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-lg bg-muted py-3 text-sm font-medium text-muted-foreground transition-all hover:bg-accent active:scale-[0.98]"
        >
      ...
      {done && (
        ...
        >
          ...
          <button
            type="button"
            onClick={onContinue}
            className="w-full rounded-lg bg-primary py-3 text-sm font-bold text-primary-foreground transition-all hover:brightness-110 active:scale-[0.98]"
          >
            Continue
          </button>
        </motion.div>
