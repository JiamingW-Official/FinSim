...
export function MobileNav() {
  ...
  return (
    <>
      {/* More menu overlay */}
      {showMore && (
        <div className="fixed inset-0 z-40 md:hidden" role="dialog" aria-label="More navigation" onClick={() => setShowMore(false)}>
      ...
      {/* Bottom nav bar */}
      <div className="fixed bottom-0 left-0 right-0 z-50 flex md:hidden h-14 items-center justify-around border-t border-border/50 bg-card/95 backdrop-blur-sm px-1 pb-[env(safe-area-inset-bottom)]">
