...
export function Sidebar() {
  ...
  return (
    ...
    <nav aria-label="Main navigation" className="relative hidden md:flex w-14 flex-col items-center border-r border-border/50 bg-sidebar py-3 gap-0">
      ...
      {/* Upgrade chip — shown only on free tier, above the bottom of the sidebar */}
      {currentTier === "free" && (
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <button
                ...
                className="flex h-8 w-10 items-center justify-center rounded-md text-primary transition-colors hover:bg-primary/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
              >
