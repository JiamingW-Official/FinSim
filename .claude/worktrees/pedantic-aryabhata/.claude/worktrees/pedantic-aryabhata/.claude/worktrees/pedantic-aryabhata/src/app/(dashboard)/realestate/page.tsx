            ...
            <tbody>
              {REITS.map((r) => (
                <tr
                  ...
                  className={cn("border-t border-border cursor-pointer transition-colors", selected === r.ticker ? "bg-muted/10" : "hover:bg-muted/30")}
                >
...
const CRE_SECTORS: CREProperty[] = [
  ...
  { type: "Data Center", icon: "", nyCapRate: 4.5, sunBeltCapRate: 5.5, vacancyRate: 2.8, avgLeaseTerm: "10-15 yr", trend: "up", note: "AI demand driving explosive leasing activity" },
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {renos
                ...
                .map((r) => (
                  <tr key={r.item} className="border-t border-border hover:bg-muted/30 transition-colors">
