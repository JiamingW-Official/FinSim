...
export function VolumeProfileChart({
  ...
  if (levels.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center gap-1 h-48 text-muted-foreground">
        <span className="text-[11px]">No volume data available</span>
        <span className="text-[10px] opacity-60">Advance the chart to generate volume profile</span>
      </div>
    );
  }
