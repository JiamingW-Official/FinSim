        ...
        >
          ...
          {activeTab === "cycle" && (
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
              {/* Clock */}
              <div className="flex flex-col items-center gap-3 bg-muted/15 rounded-lg p-4 border border-border">
              ...
              <div className="bg-muted/15 rounded-lg p-3 border border-border overflow-x-auto">
                ...
                <table className="w-full text-xs min-w-[260px]">
                  ...
                  <tbody>
                    {SECTORS.map((sec) => {
                      ...
                      return (
                        <tr key={sec.name} className="border-b border-border hover:bg-muted/30">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                {ECON_INDICATORS.map((ind) => (
                  <div key={ind.name} className="bg-muted/15 rounded-lg p-3 border border-border">
                  ...
                  <table className="w-full text-xs min-w-[560px]">
                    ...
                    <tbody>
                      {SECTORS.map((sec) => {
                        ...
                        return (
                          <tr key={sec.name} className="border-b border-border hover:bg-muted/30 transition-colors">
                            <td className="py-1.5 px-2">
                              <div className="flex items-center gap-1.5">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                {CROSS_ASSETS.map((asset) => (
                  <div key={asset.ticker} className="bg-muted/15 rounded-lg p-3 border border-border">
                    <div className="flex items-center justify-between mb-1">
              ...
              <div className="bg-muted/15 rounded-lg p-4 border border-border">
                <div className="text-xs font-semibold text-muted-foreground mb-3">
                  Risk-On / Risk-Off Barometer
                </div>
