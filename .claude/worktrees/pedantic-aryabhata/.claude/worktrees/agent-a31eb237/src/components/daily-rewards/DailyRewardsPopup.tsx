      ...
      {show && (
        ...
        >
          <motion.div
            ...
            className="relative w-full max-w-[420px] mx-4 overflow-hidden rounded-2xl border border-border/60 bg-card shadow-2xl"
          ...
          >
            ...
            <div className="px-5 pb-5 space-y-3">
              ...
              >
                {claimed ? (
                  <motion.div
                    className="flex items-center justify-center gap-2.5 rounded-xl border border-green-500/30 bg-green-500/12 px-5 py-3"
                    initial={{ scale: 0.85 }}
                    animate={{ scale: 1 }}
