  ...
  return (
    <div className="rounded-lg border border-border bg-card p-4 hover:border-border/60 transition-colors">
      ...
      <div className="mb-3 flex items-center justify-between">
        ...
        <Link
          href="/learn"
          className="flex items-center gap-0.5 text-primary text-xs hover:text-primary/80 transition-colors"
        >
          Continue
      ...
      <div className="mb-3 flex items-center gap-4">
        ...
        <div className="relative flex-shrink-0">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            <span className={cn("text-sm font-black tabular-nums", progressPct > 0 ? "text-primary" : "text-muted-foreground")}>
              {progressPct}%
            </span>
          </div>
        </div>
        ...
        {categories.map((cat) => {
          ...
          return (
            <div key={cat.id} className="flex items-center gap-2">
              <span className="w-[72px] truncate text-[10px] text-muted-foreground" title={cat.label}>
                {cat.label}
              </span>
              <div
                className={cn(
