    ...
    <div className="space-y-2">
      ...
      <AnimatePresence>
        {allComplete && (
          ...
          >
            <div className="flex items-center justify-between rounded-xl bg-green-500/10 border border-green-500/20 px-3 py-2">
              ...
              <button
                type="button"
                onClick={onContinue}
                className="rounded-lg bg-green-500 px-3 py-1.5 text-xs font-bold text-white transition-all hover:brightness-110 active:scale-[0.97]"
              >
                Continue
              </button>
            </div>
