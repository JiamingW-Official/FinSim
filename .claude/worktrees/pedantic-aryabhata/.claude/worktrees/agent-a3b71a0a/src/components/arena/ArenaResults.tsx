    ...
    <div className="flex h-full flex-col items-center justify-center gap-5 p-6 overflow-y-auto">
      ...
      >
        ...
        >
          ...
          <span className={cn(
            ...
            result.playerWon ? "text-green-400" : "text-zinc-300",
          )}>
            {playerScoreAnim}
          </span>
        </motion.div>
      ...
      >
        ...
        <StatRow
          ...
          valueColor={result.playerMaxDrawdown < 5 ? "text-green-400" : "text-zinc-200"}
        />
        <StatRow
          icon={<Zap className="h-3.5 w-3.5" />}
          label="Win Rate"
          value={`${result.playerWinRate.toFixed(0)}%`}
          valueColor={result.playerWinRate >= 50 ? "text-green-400" : "text-zinc-200"}
        />
      </motion.div>
