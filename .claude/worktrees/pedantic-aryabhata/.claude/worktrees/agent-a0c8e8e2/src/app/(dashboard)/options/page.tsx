...
export default function OptionsPage() {
  ...
  return (
    <div className="flex h-full flex-col overflow-hidden">
      ...
      >
        <TabsList className="h-8 w-full shrink-0 justify-start rounded-none border-b border-border bg-card px-2 gap-0 overflow-x-auto whitespace-nowrap scrollbar-hide">
          <TabsTrigger
            value="chains"
