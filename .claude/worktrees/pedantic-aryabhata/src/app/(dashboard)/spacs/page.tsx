...
function SpacDetailPanel({ spac, onClose }: { spac: SPAC; onClose: () => void }) {
 ...
 return (
 <div className="flex h-full flex-col overflow-y-auto border-l border-border bg-card/40 p-4">
...
function SpacArbCalculatorTab() {
 ...
 className="w-full rounded border border-border bg-background px-2.5 py-1.5 text-sm font-mono text-foreground focus:border-primary focus:outline-none"
 />
 </div>
 ))}
 </div>
...
export default function SPACsPage() {
 ...
 <TabsList className="shrink-0 justify-start gap-0 rounded-none border-b border-border bg-transparent px-4 h-9">
 {[
