...
function BHBTab() {
 ...
 <td className={cn("px-3 py-2 font-mono font-semibold", pctColor(row.total))}>{pct(row.total, 2)}</td>
 </tr>
 ))}
 </tbody>
 </table>
...
function ScenarioTab() {
 ...
 <div
 className={cn("h-full rounded-full transition-colors", excess >= 0 ? "bg-emerald-500" : "bg-rose-500")}
...
const TABS = [
 { id: "bhb", label: "BHB Attribution" },
 { id: "factor", label: "Factor Decomp." },
 { id: "active", label: "Active Share" },
 { id: "riskcontrib", label: "Risk Contrib." },
