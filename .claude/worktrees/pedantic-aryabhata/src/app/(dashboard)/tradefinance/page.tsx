...
function CompareRow({
 ...
 return (
 <div className="grid grid-cols-3 gap-2 py-2 border-b border-border text-sm">
...
function DocumentaryCollectionsTab() {
 ...
 <div className="grid grid-cols-6 gap-1 px-3 py-2 text-xs text-foreground/40 uppercase tracking-wide border-b border-border">
 <span>Code</span>
 <span>Name</span>
 <span>Seller</span>
 <span>Buyer</span>
 ...
 key={t.code}
 className={cn(
 "w-full grid grid-cols-6 gap-1 px-3 py-2 text-xs text-muted-foreground border-b border-border text-left transition-colors",
...
function FintechDigitalTab() {
 ...
 <div className="bg-foreground/5 rounded-md overflow-hidden">
 <div className="grid grid-cols-5 gap-2 px-4 py-2 text-xs text-foreground/40 uppercase tracking-wide border-b border-border">
 <span>Platform</span>
 <span>Founded</span>
 <span>Status</span>
 ...
 key={e.name}
 className={cn(
 "grid grid-cols-5 gap-2 px-4 py-3 text-xs text-muted-foreground border-b border-border",
