...
function PatternCard({
 ...
 type="button"
 onClick={onClick}
 className="group flex flex-col overflow-hidden rounded-lg border border-border bg-card text-left transition-colors hover:border-primary/40 hover:bg-muted/10"
 style={{ width: 200, minHeight: 160 }}
 >
 {/* SVG thumb */}
 <div className="flex items-center justify-center border-b border-border bg-muted/20"
...
function PatternDetail({
 ...
 {/* Large SVG */}
 <div className="overflow-hidden rounded-lg border border-border bg-muted/10" style={{ height: 250 }}>
...
function QuizSection() {
 ...
 type="button"
 onClick={startFlash}
 className="inline-flex items-center gap-2 rounded-md border border-border px-4 py-2 text-xs font-medium text-muted-foreground hover:text-foreground"
 >
 ...
 <div className="flex w-full max-w-sm flex-col overflow-hidden rounded-md border border-border bg-card">
 <div className="flex h-40 items-center justify-center border-b border-border bg-muted/20">
 ...
 className="rounded-md border border-border px-4 py-1.5 text-xs text-muted-foreground hover:text-foreground"
 >
 Prev
 </button>
 <button
 ...
 <div className="flex items-center justify-center overflow-hidden rounded-md border border-border bg-muted/20"
 ...
 !revealed && "border-border text-foreground hover:border-primary/40 hover:bg-muted/10",
...
function StatsDashboard() {
 ...
 <div className="flex gap-3">
 {sorted.map(({ p }, rank) => (
 <div key={p.id} className="flex flex-1 items-center gap-2 rounded-md border border-border bg-card px-3 py-2">
 ...
 <div key={s.sector} className="flex items-center gap-3 rounded-lg border border-border bg-card px-3 py-2.5">
