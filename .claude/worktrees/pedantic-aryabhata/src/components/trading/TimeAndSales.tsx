...
export function TimeAndSales({ ticker, currentPrice }: TimeAndSalesProps) {
 ...
 {/* Stats row */}
 <div className="flex items-center gap-3 px-2 py-1 border-b border-border text-[11px] font-mono tabular-nums">
 ...
 {/* Column headers */}
 <div className="flex items-center gap-1 px-2 py-0.5 border-b border-border text-[11px] text-muted-foreground/60">
 ...
 key={entry.id}
 className={cn(
 "flex items-center gap-1 px-2 h-[18px] text-xs font-mono tabular-nums border-b border-border",
