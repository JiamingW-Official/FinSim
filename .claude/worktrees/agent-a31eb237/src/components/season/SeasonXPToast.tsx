    ...
    <AnimatePresence>
      {lastGain && (
        <motion.div
          ...
          className="fixed bottom-6 left-1/2 z-50 flex items-center gap-2 rounded-full border border-amber-500/20 bg-zinc-900/90 px-4 py-2 shadow-xl backdrop-blur"
        >
