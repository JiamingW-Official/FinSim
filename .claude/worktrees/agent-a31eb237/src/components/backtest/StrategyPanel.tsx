  ...
  return (
    <div className="flex h-full w-[300px] flex-col gap-3 overflow-y-auto border-r border-white/5 bg-black/20 p-4">
      ...
      <button
        ...
        className="flex items-center justify-center gap-2 rounded-xl border border-violet-500/30 bg-gradient-to-r from-violet-500/10 to-fuchsia-500/10 px-4 py-2.5 text-xs font-semibold text-violet-300 transition-all hover:border-violet-500/50 hover:from-violet-500/20 hover:to-fuchsia-500/20"
      >
      ...
      <Section label="Ticker">
        <select
          ...
          className="w-full rounded-lg border border-white/10 bg-white/5 px-3 py-2 text-sm text-zinc-200 outline-none focus:border-violet-500/50 focus:ring-1 focus:ring-violet-500/30 transition-colors"
        >
        ...
        <div className="space-y-1.5">
          {entryRules.map((rule) => (
            ...
            >
              ...
              <button onClick={() => removeEntryRule(rule.id)} aria-label="Remove rule" className="text-zinc-500 hover:text-red-400">
        ...
        <div className="space-y-2">
          ...
          {positionSizing.kind === "fixed_shares" && (
            <input
              ...
              className="w-full rounded-lg border border-white/10 bg-white/5 px-3 py-1.5 text-sm text-zinc-200 outline-none focus:border-violet-500/50 focus:ring-1 focus:ring-violet-500/30 transition-colors"
            />
          )}
      ...
      <Section label="Advanced" icon={<Gauge className="h-3 w-3 text-zinc-400" />}>
        <div className="space-y-2.5">
          ...
          <div className="space-y-1">
            <label className="text-[10px] uppercase tracking-wider text-zinc-500">Warmup Period</label>
            <div className="flex items-center gap-2">
              <input
                type="range"
                min={20}
            ...
            <p className="text-[9px] text-zinc-600">Bars before first trade (indicator warmup)</p>
          </div>
      ...
      <button
        ...
        className="mt-auto flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-violet-600 to-fuchsia-600 px-4 py-3 text-sm font-bold text-white shadow-lg shadow-violet-500/20 transition-all hover:shadow-violet-500/40 disabled:opacity-40 disabled:shadow-none"
      >
