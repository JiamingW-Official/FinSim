...
function MetricCell({
  ...
  return (
    <div className="rounded-lg border border-border bg-card p-3 hover:border-border/60 transition-colors" title={tooltip}>
  ...
  return (
    <div className="flex items-center gap-3" title={description}>
      ...
      <div className="relative h-4 flex-1 rounded bg-muted/50 overflow-hidden">
        ...
        {isPositive ? (
          <div
            className="absolute top-0.5 bottom-0.5 rounded-sm bg-green-500/70"
