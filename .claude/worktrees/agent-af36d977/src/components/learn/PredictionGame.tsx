...
export function PredictionGame({ onClose }: PredictionGameProps) {
  ...
  if (phase === "summary") {
    ...
    return (
      ...
      >
        <motion.div
          className="flex h-16 w-16 items-center justify-center rounded-2xl bg-green-500/15 border border-green-500/30"
        ...
        {phase === "predict" && (
          ...
          >
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 rounded-xl border border-green-500/30 bg-green-500/10 py-3.5 text-sm font-black text-green-400 transition-all hover:bg-green-500/20 active:scale-95"
            >
