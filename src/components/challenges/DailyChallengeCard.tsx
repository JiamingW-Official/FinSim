...
const DIFFICULTY_CONFIG = {
  beginner: { bg: "bg-emerald-500/15", text: "text-emerald-500", glow: "", label: "Beginner" },
  intermediate: { bg: "bg-amber-500/15", text: "text-amber-500", glow: "", label: "Intermediate" },
  advanced: { bg: "bg-red-500/15", text: "text-red-500", glow: "", label: "Advanced" },
};
