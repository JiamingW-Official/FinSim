...
export function QuestCard({ quest, progress, onClaim }: QuestCardProps) {
 ...
 whileTap={{ scale: 0.9 }}
 onClick={handleClaim}
 className="quest-claim flex items-center gap-1 rounded-lg bg-primary px-3 py-1.5 text-xs font-semibold text-primary-foreground transition-colors hover:bg-primary"
 >
 ...
 className="flex items-center gap-1 rounded-lg border border-border bg-muted/20 px-2.5 py-1 text-xs font-semibold text-muted-foreground transition-colors duration-150 hover:bg-muted/40 hover:text-foreground"
 >
 {routeLabel}
