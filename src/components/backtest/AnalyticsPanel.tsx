...
export default function AnalyticsPanel({ result }: AnalyticsPanelProps) {
 ...
 <div
 key={p.period}
 className="group relative flex h-10 w-10 flex-col items-center justify-center rounded-md border border-border text-[11px]"
 style={{
 ...
 {/* Tooltip */}
 <div className="absolute -top-8 left-1/2 z-10 hidden -translate-x-1/2 rounded bg-muted px-2 py-1 text-xs text-muted-foreground group-hover:block whitespace-nowrap">
 {p.trades} trades
 </div>
 </div>
 );
