    ...
    <div className="relative flex-1 overflow-hidden">
      ...
      {isPreview && bars.length > 0 && !isRunning && (
        <div className="absolute left-3 top-3 z-10 flex items-center gap-2">
          <div className="rounded-lg border border-border/40 bg-card/90 px-3 py-1.5 text-[11px] text-muted-foreground shadow-sm backdrop-blur">
          ...
          {onRegenerate && (
            <button
              ...
              className="flex h-7 w-7 items-center justify-center rounded-lg border border-border/40 bg-card/90 text-muted-foreground shadow-sm backdrop-blur transition-colors hover:bg-primary/20 hover:text-primary"
            >
