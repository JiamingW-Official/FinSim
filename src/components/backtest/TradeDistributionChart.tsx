...
export default function TradeDistributionChart({ trades }: Props) {
 ...
 <div className={`text-sm font-semibold ${skewness > 0 ? "text-emerald-400" : "text-rose-400"}`}>
 {skewness.toFixed(3)}
 </div>
 ...
 <div className={`text-sm font-semibold ${kurtosis > 0 ? "text-amber-400" : "text-foreground"}`}>
 {kurtosis.toFixed(3)}
 </div>
 <div className="text-[11px] text-muted-foreground/70">
