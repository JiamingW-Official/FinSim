...
function ConditionRow({
  ...
  return (
    <div className="flex flex-wrap items-center gap-2 rounded-lg border border-border/20 bg-muted/10 px-3 py-2">
      {/* Indicator dropdown */}
      <div className="relative">
        <select
          ...
          className="appearance-none rounded-md border border-border/20 bg-card px-2 py-1 text-xs text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
        >
          {INDICATORS.map((i) => (
      ...
      <div className="relative">
        <select
          ...
          className="appearance-none rounded-md border border-border/20 bg-card px-2 py-1 text-xs text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
        >
          {CONDITIONS.map((c) => (
...
export default function VisualStrategyBuilder({ savedStrategies, onSaveStrategy, onRunCustomBacktest }: Props) {
  ...
  return (
    <div className="rounded-lg border border-border/20 bg-card/50">
      ...
      {!isCollapsed && (
        <div className="space-y-4 border-t border-border/20 px-4 pb-4 pt-3">
          ...
          <div className="flex gap-2">
            <input
              ...
              className="flex-1 rounded-md border border-border/20 bg-card px-3 py-1.5 text-xs text-foreground placeholder-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
            ...
            {savedStrategies.length > 0 && (
              <select
                ...
                className="appearance-none rounded-md border border-border/20 bg-card px-2 py-1.5 text-xs text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
              >
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                {entryConditions.length < 3 && (
                  <button
                    onClick={addEntry}
                    className="flex items-center gap-1 rounded-md border border-border/20 bg-muted/20 px-2 py-0.5 text-xs text-muted-foreground transition-colors hover:bg-muted/50"
                  >
          ...
          <div className="space-y-2">
            ...
            {/* Stop loss */}
            <div className="flex items-center gap-3 rounded-lg border border-border/20 bg-muted/10 px-3 py-2">
              ...
              <input
                ...
                placeholder="off"
                className="w-14 rounded-md border border-border/20 bg-card px-2 py-0.5 text-xs text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
              />
          ...
          <div className="space-y-1.5">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs font-semibold text-primary">{positionSize}% of portfolio</span>
            </div>
            <input
              type="range"
              min={5}
          ...
          <div className="flex gap-2 pt-1">
            <button
              onClick={handleSave}
              className="flex items-center gap-1.5 rounded-lg border border-border/20 bg-muted/20 px-3 py-1.5 text-xs font-medium text-muted-foreground transition-colors hover:bg-muted/50"
            >
