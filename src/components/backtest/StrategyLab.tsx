...
function LabMetric({ label, value, positive, sub }: { label: string; value: string; positive?: boolean; sub?: string }) {
 return (
 <div className="flex flex-col gap-0.5 rounded-md border border-border bg-card/60 px-3 py-2 min-w-[100px]">
...
export default function StrategyLab() {
 ...
 {/* Sub-tab bar */}
 <div className="flex gap-0 border-b border-border bg-black/10 overflow-x-auto shrink-0">
 {LAB_SECTIONS.map(s => (
 ...
 <div key={label} className="rounded-md border border-border bg-card/60 p-3 space-y-1.5">
 ...
 {/* Risk metrics */}
 <div className="grid grid-cols-3 gap-4">
 <Card className="border-border bg-card/50 p-4 text-center space-y-1">
 ...
 <tr key={sig.id} className="border-b border-border hover:bg-muted/30">
 ...
 {attribution && (
 <div className="grid grid-cols-3 gap-4">
 <Card className="border-border bg-card/50 p-4 text-center">
