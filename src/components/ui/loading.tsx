...
// ---------------------------------------------------------------------------
// PageLoader — premium full-page loader
// ---------------------------------------------------------------------------
export function PageLoader({ message }: { message?: string }) {
 ...
 <span className="font-sans text-xs font-semibold tracking-[0.3em] uppercase text-foreground/50">
 Alpha Deck
 </span>
 {/* Animated line */}
 <div className="relative w-32 h-px bg-border overflow-hidden">
 <div
 className="absolute inset-y-0 w-1/2 bg-foreground/30"
 style={{
 ...
 {message && (
 <p className="text-[11px] font-mono text-muted-foreground/30 tracking-widest uppercase">
 {message}
 </p>
 )}
 </div>
