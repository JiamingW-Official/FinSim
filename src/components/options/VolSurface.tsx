...
export function VolSurface({ spotPrice, hv = 0.25, ivRank = 50 }: VolSurfaceProps) {
 ...
 {/* Header bar */}
 <div className="flex shrink-0 flex-wrap items-center gap-3 border-b border-border bg-card px-3 py-2">
 {/* Spot + IV Rank */}
 <div className="flex items-center gap-2">
 ...
 {tooltip && (
 <div
 className="pointer-events-none absolute z-10 rounded border border-border bg-card/95 px-2 py-1.5"
 style={{
 left: tooltip.x + 10,
 top: tooltip.y - 30,
 maxWidth: 140,
