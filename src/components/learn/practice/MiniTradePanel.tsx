          ...
          <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: "auto" }} exit={{ opacity: 0, height: 0 }} className="overflow-hidden">
            <div className={cn(
              ...
              <div className="flex items-center gap-1.5">
                ...
                <span className={cn("text-[10px] font-bold uppercase", position.side === "long" ? "text-emerald-400" : "text-red-400")}>
                  {position.side}
                </span>
        ...
        <div className="space-y-1.5">
          ...
          <div className="flex items-center gap-1.5">
            <motion.button type="button" onClick={handleBuy}
              ...
              whileTap={{ scale: 0.95 }}
              className="flex-1 flex items-center justify-center gap-1 rounded-lg bg-emerald-500 py-2 text-xs font-black text-white uppercase tracking-wide transition-all hover:brightness-110 disabled:opacity-30 shadow-[0_2px_8px_rgba(16,185,129,0.25)]">
          ...
          {showLegacyBuy && (
            <>
              ...
              <motion.button type="button" onClick={handleBuy}
                ...
                whileTap={{ scale: 0.95 }}
                className="flex-1 rounded-lg bg-emerald-500 py-2 text-xs font-black text-white uppercase tracking-wide transition-all hover:brightness-110 disabled:opacity-40 shadow-[0_2px_8px_rgba(16,185,129,0.25)]">
                Buy {qty}
              </motion.button>
            </>
          )}
