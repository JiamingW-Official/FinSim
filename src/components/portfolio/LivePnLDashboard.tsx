...
export function LivePnLDashboard() {
 ...
 {/* Unrealized */}
 <div>
 <p className="text-[10px] text-muted-foreground/60 uppercase tracking-widest mb-0.5">Unrealized P&L</p>
 ...
 <p className="text-[10px] text-muted-foreground/60 uppercase tracking-widest mb-0.5">Today Realized</p>
 <p
 className={cn(
 ...
 {/* Total */}
 <div className="text-right">
 <p className="text-[10px] text-muted-foreground/60 uppercase tracking-widest mb-0.5">All-Time P&L</p>
 <p
 className={cn(
 "text-base font-semibold tabular-nums",
