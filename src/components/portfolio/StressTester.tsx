  ...
  return (
    <div
      className={cn(
        ...
        isActive ? "border-primary/60 bg-primary/5" : "border-border/20 hover:border-border/80",
      )}
    >
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
        <div className="rounded-lg border border-border/20 bg-card/50 p-3">
          ...
          <p className={cn("text-sm font-semibold tabular-nums", impactColor)}>
        ...
        <div className="rounded-lg border border-border/20 bg-card/50 p-3">
          ...
          <p className={cn("text-sm font-semibold tabular-nums", riskLevel.color.split(" ")[0])}>
        ...
        <div className="rounded-lg border border-border/20 bg-card/50 p-3">
          ...
          {result.worstPosition ? (
            <>
              <p className="text-sm font-semibold text-red-400">{result.worstPosition.ticker}</p>
      ...
      {result.positionImpacts.length === 0 && (
        <div className="flex flex-col items-center gap-2 rounded-lg border border-dashed border-border/20 py-8">
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        {statItems.map((item) => {
          ...
          return (
            <div key={item.label} className="rounded-lg border border-border/20 bg-card/50 p-3">
      ...
      <div className="rounded-lg border border-border/20 bg-card/50 px-3 py-2">
    ...
    <div className="space-y-4">
      ...
      <div className="flex gap-2 pt-2">
        <input
          ...
          className="h-8 flex-1 rounded-md border border-border/20 bg-background px-2.5 text-[11px] text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
      ...
      {activeSection === "results" && (
        <div className="space-y-3">
          ...
          {stressResult ? (
            ...
            <div className="flex flex-col items-center gap-3 rounded-lg border border-dashed border-border/20 py-12">
