...
function IncomeDashboard() {
 ...
 <div className="lg:col-span-2 bg-muted/20 border border-border rounded-lg p-4">
...
function DividendSafetyScoring() {
 ...
 <div className={cn("rounded-lg p-3 border", atRiskCount > 0 ? "bg-red-500/5 border-red-500/30" : "bg-muted/30 border-border")}>
 ...
 {selectedResult && (
 <div className={cn("rounded-lg border p-4 space-y-3", selectedResult.atRisk ? "bg-red-500/5 border-red-500/30" : "bg-muted/20 border-border")}>
...
function ExDivCalendar() {
 ...
 {/* Monthly calendar */}
 {months.map((ym) => (
 <div key={ym} className="bg-muted/20 border border-border rounded-lg overflow-hidden">
...
function DividendGrowthStrategy() {
 ...
 <span className="px-1.5 py-0.5 bg-muted/40 rounded border border-border">Yield 0.5–5%</span>
 <span className="px-1.5 py-0.5 bg-muted/40 rounded border border-border">Growth &gt;5%</span>
 <span className="px-1.5 py-0.5 bg-muted/40 rounded border border-border">Payout &lt;70%</span>
 <span className="px-1.5 py-0.5 bg-muted/40 rounded border border-border">FCF &gt;1.5x</span>
 </div>
 </div>
