  ...
  const methods = [
    {
      ...
      tag: "Data-driven",
      tagCls: "bg-blue-500/20 text-blue-600 dark:text-blue-400",
    ...
    },
    {
      ...
      tag: "Comprehensive",
      tagCls: "bg-purple-500/20 text-purple-600 dark:text-purple-400",
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
            {methods.map((m) => (
              <div key={m.name} className="rounded-lg border border-border/60 p-3 space-y-2">
