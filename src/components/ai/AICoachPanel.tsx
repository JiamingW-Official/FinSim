...
function LevelLadder({
 ...
 return (
 <div className="rounded-md bg-background/40 border border-border px-2 py-1.5 space-y-0.5">
 {nearestRes && (
 ...
 <div className="flex items-center justify-between text-[11px] py-0.5 border-y border-border">
...
function ProfileCard({ profile }: { profile: AnalysisResult["traderProfile"] }) {
 ...
 return (
 <div className="rounded bg-background/40 border border-border px-2 py-1.5 space-y-0.5">
...
function MultiTimeframePanel({ barIndex, bias }: { barIndex: number; bias: string }) {
 ...
 return (
 <div
 className="rounded-md border border-border bg-background/30 px-2 py-2 space-y-1.5"
 >
...
function StrategyConfidenceMeter({ result, currentPrice }: { result: AnalysisResult; currentPrice: number }) {
 ...
 return (
 <div
 className="rounded-md border border-border bg-background/30 px-2 py-2 space-y-1"
 >
 <div className="flex items-center justify-between">
 <div className="text-[11px] font-medium text-foreground/50">
 Confidence Check
...
function TradePlanCard({ plan, conviction }: { plan: TradePlan; conviction: string }) {
 ...
 return (
 <div
 className="rounded-md border border-border bg-muted/30 px-2 py-2 space-y-1"
 >
 <div className="text-[11px] font-medium text-foreground/50">
 Suggested Plan
 </div>
 ...
 <p className="text-[10px] text-muted-foreground/60 leading-tight border-t border-border pt-1">
 {plan.rationale}
 </p>
 </div>
 );
...
export function AICoachPanel() {
 ...
 return (
 <div className="shrink-0 border-t border-border bg-transparent">
