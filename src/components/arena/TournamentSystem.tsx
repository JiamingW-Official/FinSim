...
function TournamentLobby({ joinedIds, onJoin, onViewLeaderboard, playerXP }: TournamentLobbyProps) {
 ...
 : "border border-border bg-muted/10 text-muted-foreground/70 cursor-not-allowed",
 )}
 >
 {canAfford ? (
 <>
...
function H2HSection({ playerElo }: H2HProps) {
 ...
 <div key={s.label} className="rounded-lg border border-border bg-muted/10 p-3 text-center">
 ...
 className="w-full rounded-lg border border-border bg-muted/10 py-2 pl-8 pr-3 text-xs text-muted-foreground placeholder:text-muted-foreground/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
 ...
 className="rounded-lg border border-border bg-muted/15 px-3 py-2 text-xs font-semibold text-muted-foreground transition-colors hover:bg-muted/30 disabled:opacity-40"
 >
 Challenge
 </button>
 </div>
...
function HallOfFameSection({ playerElo, playerXP, joinedCount }: HallOfFameProps) {
 ...
 <div key={award.label} className="rounded-lg border border-border bg-muted/10 p-3">
...
export function TournamentSystem() {
 ...
 <div className="flex rounded-md border border-border bg-muted/10 overflow-hidden">
