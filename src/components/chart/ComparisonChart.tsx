              ...
              {addingTicker ? (
                <div className="flex items-center gap-1">
                  <select
                    ...
                    className="h-5 rounded border border-border/20 bg-background px-1 text-xs text-foreground"
                  >
                  ...
                  <button
                    ...
                    disabled={!addInput}
                    className="h-5 rounded border border-border/20 bg-primary/20 px-1.5 text-xs text-primary hover:bg-primary/30 disabled:opacity-40"
                  >
                    Add
                  </button>
                  <button
                    onClick={() => { setAddingTicker(false); setAddInput(""); }}
                    className="h-5 rounded border border-border/20 bg-muted/30 px-1.5 text-xs text-muted-foreground hover:bg-muted/50"
                  >
                    <X size={9} />
                  </button>
                </div>
                ...
                <button
                  ...
                  className="inline-flex items-center gap-0.5 rounded-full border border-dashed border-border/20 px-2 py-0.5 text-xs text-muted-foreground hover:border-primary hover:text-primary transition-colors"
                >
                  <Plus size={9} />
                  Add
                </button>
