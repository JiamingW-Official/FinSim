...
export function MobileNav() {
 ...
 className="fixed bottom-0 left-0 right-0 z-50 flex md:hidden h-14 items-center justify-around border-t border-border bg-card px-1 pb-[env(safe-area-inset-bottom)]"
 >
