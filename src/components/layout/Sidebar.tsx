...
function NavLink({
 ...
 className={cn(
 "group relative flex items-center rounded-md transition-all duration-150 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary/30",
 collapsed
 ? "h-8 w-8 justify-center"
 : "h-7 w-full gap-2 px-2 hover:translate-x-[2px]",
 isActive
 ...
 className="absolute -left-[1px] top-1/2 -translate-y-1/2 h-3 w-[2px] rounded-r-full bg-foreground/30"
...
export function Sidebar() {
 ...
 <div
 className={cn(
 "relative hidden md:flex flex-col border-r border-border bg-sidebar py-2 transition-[width] duration-200 ease-in-out overflow-hidden",
 ...
 <span className="font-sans text-sm font-semibold tracking-tight text-foreground/80 select-none">Alpha Deck</span>
 )}
 </div>
 ...
 <span className="text-[9px] uppercase tracking-[0.15em] text-muted-foreground/30 select-none">
 {cat.label}
 </span>
 </div>
 )}
