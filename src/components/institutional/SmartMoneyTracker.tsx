  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-lg border border-border/60 bg-card p-4">
        ...
        <p className="text-[10px] text-muted-foreground mb-3">Alpha generated by copying top-10 13F filings (simulated)</p>
          ...
          >
            <div className="flex items-start justify-between gap-2">
              <div className="min-w-0">
                ...
                <p className="text-[10px] text-muted-foreground mt-0.5">AUM {fmtB(fund.aum)} · Filed {fund.filingDate}</p>
              </div>
              <div className="flex shrink-0 flex-col items-end gap-1">
                ...
                {fund.soldPositions > 0 && (
                  <span className="rounded px-1.5 py-0.5 text-[10px] font-medium bg-red-500/15 text-red-400">
          ...
          >
            <div className="px-4 py-3 border-b border-border/60 flex items-center justify-between">
              <div>
                ...
                <p className="text-[10px] text-muted-foreground mt-0.5">Top 5 Holdings · Q-end {selected.quarterEnd}</p>
              </div>
              <button
                  ...
                  {selected.holdings.map((h) => (
                    <tr key={h.ticker} className="border-b border-border/20 last:border-0">
                      ...
                      <td className="p-2.5 text-right">
                        <span className={cn("rounded px-1.5 py-0.5 text-[10px] font-medium capitalize", QTR_CHANGE_STYLE[h.qtrChange])}>
                          {h.qtrChange}
                        </span>
                      </td>
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-lg border border-border/60 bg-card p-4">
        ...
        <p className="text-[10px] text-muted-foreground mb-3">Stocks owned by 2+ gurus (highest conviction)</p>
        <div className="flex flex-wrap gap-2">
          {overlap.map((item) => (
            <div key={item.ticker} className="rounded-md border border-primary/30 bg-primary/5 px-3 py-2">
              ...
              <p className="text-[10px] text-muted-foreground mt-0.5">{item.count} gurus · {item.guruNames.join(", ")}</p>
            </div>
          ))}
        </div>
      </div>
            ...
            <div key={guru.name} className="rounded-lg border border-border/60 bg-card overflow-hidden">
              ...
              >
                <div className="min-w-0">
                  ...
                  <p className="text-[10px] text-muted-foreground">{guru.style} Investor</p>
                </div>
                <div className="flex items-center gap-3 shrink-0">
                  <div className="text-right hidden sm:block">
                    <p className="text-[10px] text-muted-foreground">1yr Alpha</p>
                ...
                {isOpen && (
                  ...
                  >
                    <div className="px-4 py-3 space-y-3">
                            ...
                            <div key={row.label}>
                              ...
                              <div className="space-y-1">
                                <div className="flex items-center gap-1.5">
                                  ...
                                  <span className={cn("text-[10px] font-medium", row.guru >= 0 ? "text-emerald-400" : "text-red-400")}>
                                    {fmtPct(row.guru)}
                                  </span>
                                </div>
                                <div className="flex items-center gap-1.5">
                                  ...
                                  <span className="text-[10px] text-sky-400">{fmtPct(row.sp)} SPX</span>
                                </div>
                              </div>
                            </div>
                          );
                      ...
                      {/* Picks table */}
                      <div>
                        <p className="text-[10px] text-muted-foreground uppercase tracking-wider mb-1.5">Recent Positions</p>
                        <div className="space-y-1">
                          {guru.picks.map((p) => (
  ...
  return (
    <div className="space-y-4">
        ...
        <div className="flex flex-wrap gap-2 mt-1">
          {pieData.map((slice) => (
            <div key={slice.label} className="flex items-center gap-1.5">
              ...
              <span className="text-[10px] text-muted-foreground">{slice.label} ({slice.pct}%)</span>
            </div>
          ))}
        </div>
      </div>
            ...
            {filtered.map((trade) => (
              <tr key={trade.id} className="border-b border-border/20 last:border-0">
                <td className="p-2.5">
                  ...
                  <p className="text-[10px] text-muted-foreground">{trade.chamber}</p>
                </td>
                ...
                <td className="p-2.5 text-right text-muted-foreground text-[10px]">{trade.amount}</td>
                <td className="p-2.5 text-right text-muted-foreground text-[10px]">{trade.dateFiled}</td>
                <td className={cn(
      ...
      <div className="rounded-lg border border-border/60 bg-card p-3">
        <p className="text-[10px] text-muted-foreground uppercase tracking-wider mb-2">Upcoming Legislative Catalysts</p>
              ...
              <div>
                ...
                <div className="flex gap-1 mt-0.5">
                  {item.sectors.map((sec) => (
                    <span key={sec} className="text-[10px] bg-muted/40 text-muted-foreground rounded px-1 py-0.5">{sec}</span>
                  ))}
                </div>
              </div>
              <span className="text-[10px] text-muted-foreground shrink-0 ml-3">{item.date}</span>
            </div>
          ))}
        </div>
      </div>
              ...
              return (
                <tr key={row.ticker} className="border-b border-border/20 last:border-0">
                  <td className="p-2.5">
                    ...
                    <p className="text-[10px] text-muted-foreground truncate max-w-[90px]">{row.name}</p>
                  </td>
                  <td className="p-2.5 text-right">
                  ...
                  <td className="p-2.5">
                    ...
                    <p className="text-[9px] text-muted-foreground mt-0.5">{row.painMeter.toFixed(1)}</p>
                  </td>
                </tr>
              );
            })}
          ...
          {SHORT_SELLERS.map((r2) => (
            <div key={r2.name + r2.date} className="flex items-center justify-between">
              <div>
                ...
                <p className="text-[10px] text-muted-foreground">Target: <span className="text-amber-400 font-medium">{r2.target}</span> · {r2.date}</p>
              </div>
        ...
        <div className="space-y-3">
          {HISTORICAL_SQUEEZES.map((sq) => (
            <div key={sq.ticker} className="flex items-start gap-3">
              <span className="text-lg font-black text-foreground shrink-0 w-12">{sq.ticker}</span>
              <div>
                <p className="text-emerald-400 font-semibold text-xs">{sq.peak}</p>
                <p className="text-[10px] text-muted-foreground mt-0.5">{sq.catalyst}</p>
              </div>
            </div>
          ))}
        </div>
    ...
    <div className="space-y-4">
        ...
        <div className="space-y-2">
          {sectorConc.map((item) => (
            <div key={item.sector} className="flex items-center gap-3">
              <span className="text-[10px] text-muted-foreground w-20 shrink-0">{item.sector}</span>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <div className="rounded-lg border border-sky-500/20 bg-sky-500/5 p-3">
          <p className="text-[10px] font-semibold text-sky-400 mb-1">LEAP Conviction Signal</p>
        ...
        <div className="rounded-lg border border-purple-500/20 bg-purple-500/5 p-3">
          <p className="text-[10px] font-semibold text-purple-400 mb-1">Earnings Straddling</p>
          <p className="text-[10px] text-muted-foreground">
            ...
            {filtered.map((trade) => (
              <tr key={trade.id} className="border-b border-border/20 last:border-0">
                <td className="p-2.5">
                  ...
                  <p className="text-[10px] text-muted-foreground">{trade.sector}</p>
                </td>
                <td className="p-2.5 font-semibold text-foreground">{trade.ticker}</td>
                <td className="p-2.5">
                  <span className={cn(
                ...
                <td className="p-2.5 text-right">
                  {trade.repeatCount >= 2 ? (
                    <span className="rounded px-1 py-0.5 bg-purple-500/15 text-purple-400 text-[10px] font-medium">
                      ×{trade.repeatCount}
                    </span>
                  ) : (
                ...
                <td className="p-2.5">
                  <div className="flex gap-1 flex-wrap">
                    {trade.isLeap && (
                      <span className="rounded px-1.5 py-0.5 bg-sky-500/15 text-sky-400 text-[9px] font-medium">LEAP</span>
                    )}
                    {trade.isEarningsStraddle && (
                      <span className="rounded px-1.5 py-0.5 bg-amber-500/15 text-amber-400 text-[9px] font-medium">STRDL</span>
                    )}
                  </div>
                </td>
              </tr>
      ...
      <div className="rounded-lg border border-border/60 bg-card p-3">
        <p className="text-[10px] text-muted-foreground uppercase tracking-wider mb-1.5">Pattern Glossary</p>
