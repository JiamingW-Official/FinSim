...
export default function NotFound() {
 ...
 key={href}
 href={href}
 className="flex flex-col items-start gap-1 rounded-lg border border-border bg-card px-4 py-3 text-left transition-colors duration-150 hover:bg-muted/20 hover:border-border"
 >
