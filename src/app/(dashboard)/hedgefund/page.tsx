...
function StrategyExplorer() {
 ...
 <div className="flex items-center gap-1.5 mb-1 text-emerald-400 text-xs font-medium ">
 Best environment
 </div>
...
function GlobalMacroSimulator() {
 ...
 <p className="text-xs text-muted-foreground mb-1.5">Recommended trades in {regime.name}</p>
 {regime.trades.map((t) => (
...
function CTASimulator() {
 ...
 <p className="text-xs text-muted-foreground">
 <span className="text-foreground font-medium">Crisis Alpha: </span>
...
export default function HedgeFundPage() {
 ...
 { value: "cta", label: "CTA / Futures" },
 { value: "economics", label: "Fund Economics" },
 ].map(({ value, label }) => (
 <TabsTrigger
 key={value}
 value={value}
