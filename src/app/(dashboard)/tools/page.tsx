...
function DigitalTwinTab() {
 ...
 <div
 className="absolute inset-y-0 left-0 rounded-full bg-primary transition-colors duration-300"
 style={{ width: `${goalPct}%` }}
 />
 </div>
...
function CompoundCalculatorTab() {
 ...
 <span className="font-mono font-medium text-foreground">{rule72} years</span>.
 </p>
...
function MacroSimulatorTab() {
 ...
 <div
 className={`absolute inset-y-0 rounded-full transition-colors duration-300 ${pos ? "left-1/2 bg-green-500" : "right-1/2 bg-red-400"}`}
...
export default function ToolsPage() {
 ...
 <Badge className="bg-muted/10 text-foreground border-primary/30 text-xs">Featured</Badge>
 </div>
 </div>
 )}
