...
function PodStructureTab() {
 ...
 <p className="text-2xl font-semibold text-foreground">${(totalAum / 1000).toFixed(1)}B</p>
...
function RiskManagementTab() {
 ...
 <div className="flex-1 bg-muted rounded-full h-1.5">
 <div className="h-1.5 rounded-full transition-colors" style={{ width: `${m.pctUsed}%`, background: m.pctUsed > 80 ? "#ef4444" : m.pctUsed > 65 ? "#f59e0b" : "#22c55e" }} />
 </div>
...
function EconomicsTab() {
 ...
 <li className="flex gap-1.5">PM compensation (salary + bonus)</li>
 <li className="flex gap-1.5">Research data (Bloomberg, FactSet, alt data)</li>
 <li className="flex gap-1.5">Technology infrastructure</li>
 <li className="flex gap-1.5">Prime brokerage fees</li>
 <li className="flex gap-1.5">Risk management software</li>
 <li className="flex gap-1.5">Compliance + legal</li>
 <li className="flex gap-1.5">Office space + travel</li>
 </ul>
 </div>
 <div className="p-3 bg-muted/50 rounded-lg border border-border">
 ...
 <p className="font-medium text-muted-foreground mb-2 flex items-center gap-1.5">Capacity Constraints at $50B+</p>
 ...
 <div className="p-3 bg-muted/40 rounded-lg border border-border text-xs text-muted-foreground">
 <p className="font-medium text-muted-foreground mb-2 flex items-center gap-1.5">Talent War &amp; Compensation Inflation</p>
