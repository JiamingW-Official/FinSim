...
export default function LoanSyndPage() {
 ...
 <div key={i} className="grid grid-cols-3 gap-2 py-1.5 border-b border-border">
 ...
 <div key={i} className="flex justify-between items-start py-1.5 border-b border-border">
