...
export default function BankingRegPage() {
 ...
 <h1 className="text-2xl font-semibold tracking-tight">Banking Regulation &amp; Capital</h1>
 ...
 <TabsTrigger value="resolution" className="rounded-none border-b-2 border-transparent data-[state=active]:border-foreground data-[state=active]:bg-transparent data-[state=active]:shadow-none px-3 py-2 text-xs text-muted-foreground data-[state=active]:text-foreground">
 Resolution Planning
 </TabsTrigger>
 <TabsTrigger value="deposit" className="rounded-none border-b-2 border-transparent data-[state=active]:border-foreground data-[state=active]:bg-transparent data-[state=active]:shadow-none px-3 py-2 text-xs text-muted-foreground data-[state=active]:text-foreground">
 Deposit Insurance
 </TabsTrigger>
 </TabsList>
 ...
 <StatChip label="Conservation" value="+2.5%" color="text-foreground" />
 </div>
 </CardContent>
 </Card>
 ...
 <Badge className="bg-muted/60 text-foreground text-sm font-medium">{info.surcharge}</Badge>
 ...
 <ExpandableRow title="Model Validation Governance" accent="text-foreground">
 ...
 <StatChip label="TLAC Phase 2" value="18%" color="text-foreground" />
 ...
 <ExpandableRow title="Fintech Bank Charter Options" accent="text-foreground">
 <p><span className="text-foreground font-medium">National Bank Charter (OCC):</span> Full banking powers, federal preemption of state consumer laws. Requires CRA compliance, capital standards.</p>
 <p className="mt-1"><span className="text-foreground font-medium">Industrial Loan Company (ILC):</span> State-chartered, FDIC-insured, not subject to BHC Act. Allows commercial firms (e.g., Square/Block) to own a bank.</p>
 <p className="mt-1"><span className="text-foreground font-medium">Special Purpose Charter:</span> OCC proposed fintech charter in 2016; repeatedly challenged in courts. As of 2025, no approved fintech-specific national charter exists.</p>
 <p className="mt-1"><span className="text-foreground font-medium">BaaS (Banking-as-a-Service):</span> Most fintechs partner with FDIC-insured banks (sponsor banks) rather than obtaining their own charter.</p>
 </ExpandableRow>
 </div>
 <div className="space-y-2">
