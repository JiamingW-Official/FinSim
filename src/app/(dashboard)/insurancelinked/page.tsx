        ...
        >
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            <TabsList className="bg-muted border border-border h-9 mb-4">
              <TabsTrigger value="catbonds" className="text-xs text-muted-foreground data-[state=active]:bg-background">
                <Shield className="w-3 h-3 mr-1" />Cat Bonds
              </TabsTrigger>
              <TabsTrigger value="ilsfunds" className="text-xs text-muted-foreground data-[state=active]:bg-background">
                <Layers className="w-3 h-3 mr-1" />ILS Funds
              </TabsTrigger>
              <TabsTrigger value="riskmodel" className="text-xs text-muted-foreground data-[state=active]:bg-background">
                <Activity className="w-3 h-3 mr-1" />Risk Modeling
              </TabsTrigger>
              <TabsTrigger value="history" className="text-xs text-muted-foreground data-[state=active]:bg-background">
