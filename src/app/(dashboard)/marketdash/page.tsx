...
export default function MarketDashPage() {
 ...
 s.reason === "sector" ? "bg-muted/10 text-foreground" :
 ...
 <div
 className="h-full bg-emerald-500 rounded-full transition-colors duration-200"
 ...
 <div className="h-3 bg-muted rounded-full overflow-hidden">
 <div
 className="h-full bg-red-500 rounded-full transition-colors duration-200"
