...
export default function RiskModelsPage() {
 ...
 <div className="text-xs font-semibold text-muted-foreground ">Basel 2.5 (Old)</div>
 ...
 <div className="bg-muted/40 rounded-lg p-3 space-y-1">
 <div className="text-xs font-semibold text-indigo-300 ">FRTB IMA (New)</div>
 ...
 <td className={cn("py-2 px-2 font-mono", sc.rates > 0 ? "text-amber-400" : "text-foreground")}>
 ...
 <div className="text-xs font-medium text-foreground mb-1">Sensitivity Analysis</div>
 ...
 <div className="bg-muted/30 rounded-lg p-3">
 <div className="text-xs font-medium text-foreground mb-1">Scenario Analysis</div>
