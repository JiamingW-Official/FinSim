...
function DebtOverviewTab() {
 ...
 <div className="grid grid-cols-3 gap-1 text-center text-xs text-muted-foreground mt-1">
 {[
...
function PayoffStrategiesTab() {
 ...
 <div key={item.label} className="p-3 rounded-lg bg-muted/60 border border-border">
...
function MortgageOptimizationTab() {
 ...
 <div key={item.term} className="p-4 rounded-lg bg-muted/60 border border-border">
...
function CreditBehavioralTab() {
 ...
 { name: "Travel", monthly: 300, bestCard: "Capital One Venture", cashback: 0.02, icon: "" },
 ...
 <div key={z.range} className="p-2 rounded-lg bg-muted/60 border border-border">
 ...
 <div key={cat.name} className="p-2 rounded-lg bg-muted/60 border border-border text-center">
