...
export default function VolatilityArbPage() {
 ...
 <div className="text-red-400 text-lg font-semibold">{richCount}</div>
 ...
 <div className="text-2xl font-semibold text-green-400">30%</div>
 ...
 { label: "Vol Arb Edge", value: "8 vol pts", color: "text-foreground" },
 ].map((s) => (
 ...
 <div className="text-lg font-medium text-foreground">{(indexIV * 100).toFixed(1)}%</div>
 </CardContent>
 </Card>
 <Card className="bg-muted/5 border-border">
 <CardContent className="pt-4">
 <div className="text-xs text-muted-foreground">Basket IV (weighted)</div>
 <div className="text-lg font-medium text-foreground">{(basketIV * 100).toFixed(1)}%</div>
 </CardContent>
 </Card>
 ...
 <div className="text-xs font-semibold text-foreground mb-1">SELL</div>
 ...
 <div className="text-xs text-foreground mt-2">IV: {(indexIV * 100).toFixed(1)}%</div>
 </div>
 <div className="p-3 bg-muted/30 rounded-lg">
 ...
 <td className="text-right pr-4 font-mono text-foreground">
 ...
 <td className="text-right pr-4 font-mono text-foreground">{(basketIV * 100).toFixed(1)}%</td>
 <td className="text-right pr-4 font-mono text-foreground">{(basketIV * 100).toFixed(2)}%</td>
 ...
 <CardContent>
 <div className="mb-3 p-3 bg-muted/5 border border-border rounded-lg text-xs text-muted-foreground">
 ...
 <div className="text-lg font-medium text-foreground">{(avgVRP * 100).toFixed(1)} vols</div>
 ...
 <div className="text-lg font-medium text-foreground">0.8–1.2</div>
 ...
 <div className="text-xs font-medium text-muted-foreground ">Risk Sources</div>
 {[
 ...
 <div className="space-y-3">
 <div className="text-xs font-medium text-muted-foreground ">Mitigation Strategies</div>
 {[
