...
function Tab1CustodyArchitecture() {
 ...
 <th className="text-center text-foreground font-medium py-2 px-3">Multi-Sig</th>
 </tr>
 </thead>
 <tbody>
 ...
 <div className="text-indigo-400 font-semibold text-xs mb-0.5">Step {step.step}</div>
...
function Tab4SecurityInsurance() {
 ...
 <p className="text-xs text-foreground">Providers: {ins.providers}</p>
 </div>
 ))}
 </div>
 <InfoBox variant="amber">
...
export default function DigitalCustodyPage() {
 ...
 <div>
 <h1 className="text-xl font-semibold text-foreground">Digital Asset Custody</h1>
 ...
 {[
 { label: "Hot/Cold Wallets", color: "bg-muted/10 text-foreground border-border" },
 { label: "MPC Technology", color: "bg-cyan-500/20 text-muted-foreground border-cyan-500/30" },
 { label: "SEC / OCC", color: "bg-muted/10 text-foreground border-border" },
 ...
 <TabsTrigger value="security" className="rounded-none border-b-2 border-transparent data-[state=active]:border-foreground data-[state=active]:bg-transparent data-[state=active]:shadow-none px-3 py-2 text-xs text-muted-foreground data-[state=active]:text-foreground">
