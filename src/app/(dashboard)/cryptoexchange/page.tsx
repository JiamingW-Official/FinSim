...
export default function CryptoExchangePage() {
 ...
 <TabsTrigger value="perp" className="rounded-none border-b-2 border-transparent data-[state=active]:border-foreground data-[state=active]:bg-transparent data-[state=active]:shadow-none px-3 py-2 text-xs text-muted-foreground data-[state=active]:text-foreground">
 Perpetuals
 </TabsTrigger>
 ...
 <TabsTrigger value="defi" className="rounded-none border-b-2 border-transparent data-[state=active]:border-foreground data-[state=active]:bg-transparent data-[state=active]:shadow-none px-3 py-2 text-xs text-muted-foreground data-[state=active]:text-foreground">
 DeFi Dashboard
 </TabsTrigger>
 ...
 className={cn("flex-1 py-2 rounded-lg text-sm font-semibold transition-colors", orderSide === "buy" ? "bg-green-600 text-foreground" : "bg-muted text-muted-foreground hover:bg-green-900/30 hover:text-green-400")}
 >
 Buy
 </button>
 <button
 onClick={() => setOrderSide("sell")}
 className={cn("flex-1 py-2 rounded-lg text-sm font-semibold transition-colors", orderSide === "sell" ? "bg-red-600 text-foreground" : "bg-muted text-muted-foreground hover:bg-red-900/30 hover:text-red-400")}
 >
 Sell
 </button>
 </div>
 ...
 className={cn("px-4 py-2 rounded-lg text-sm font-medium transition-colors", perpPair === pair ? "bg-indigo-600 text-foreground" : "bg-muted text-muted-foreground hover:bg-muted")}
 >
 {pair} PERP
 </button>
 ))}
 ...
 className={cn("px-2 py-1 rounded text-xs transition-colors", leverage === lv ? "bg-amber-600 text-foreground" : "bg-muted text-muted-foreground hover:bg-muted")}
 >
 {lv}x
 </button>
 ))}
 ...
 <button
 onClick={() => setOrderSide("buy")}
 className={cn("flex-1 py-2 rounded-lg text-sm font-medium transition-colors", orderSide === "buy" ? "bg-green-600 text-foreground" : "bg-muted text-muted-foreground hover:text-green-400")}
 >
 Long {leverage}x
 </button>
 <button
 onClick={() => setOrderSide("sell")}
 className={cn("flex-1 py-2 rounded-lg text-sm font-medium transition-colors", orderSide === "sell" ? "bg-red-600 text-foreground" : "bg-muted text-muted-foreground hover:text-red-400")}
 >
 Short {leverage}x
 </button>
 </div>
 ...
 ETH: "text-indigo-400",
 BSC: "text-amber-400",
 Polygon: "text-foreground",
 Arbitrum: "text-foreground",
