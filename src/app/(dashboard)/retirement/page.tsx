...
function AccountsTab() {
 ...
 <tbody>
 {ACCOUNTS.map((a, i) => (
 <tr key={a.name} className={cn("border-b border-border hover:bg-muted/20 transition-colors", i % 2 === 0 ? "" : "bg-muted/10")}>
 <td className="p-3">
...
function HealthcareRMDsTab() {
 ...
 <tbody>
 {rmdData.map((d, i) => (
 <tr key={d.age} className={cn("border-b border-border hover:bg-muted/20", i % 2 === 0 ? "" : "bg-muted/10")}>
