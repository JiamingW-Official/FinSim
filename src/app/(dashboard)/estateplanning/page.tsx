...
function EstatePlanningBasicsTab() {
 ...
 <tr key={d.doc} className="border-b border-border hover:bg-muted/20 transition-colors">
...
function TrustsTab() {
 ...
 return (
 <div key={d.abbrev} className="flex items-center gap-4 rounded-lg border border-border px-4 py-3">
...
function TaxStrategiesTab() {
 ...
 <div key={s.state} className="flex items-center justify-between rounded-md border border-border px-3 py-1.5">
...
function CharitableGivingTab() {
 ...
 <tr key={row.v} className="border-b border-border hover:bg-muted/20 transition-colors">
