...
export default function CrossAssetMomPage() {
 ...
 <div key={item.title} className="bg-muted/60 rounded-lg p-3 border border-border">
 ...
 <div key={p.period} className="bg-muted/60 border border-border rounded-lg p-3">
 ...
 <div key={item.title} className="bg-muted/60 border border-border rounded-lg p-3">
 ...
 <div key={f.name} className="bg-muted/60 border border-border rounded-lg p-3">
