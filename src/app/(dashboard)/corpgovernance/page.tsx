...
function OwnershipDonut({ data }: { data: Shareholder[] }) {
 ...
 <text x={CX} y={CY - 6} textAnchor="middle" className="fill-white text-xs font-semibold" fontSize={11}>
 {total.toFixed(1)}%
 </text>
...
function ProxyVoteSimulator() {
 ...
 <Badge className={cn("text-xs px-1.5 py-0", res.type === "Management" ? "bg-muted/10 text-foreground" : "bg-muted/10 text-foreground")}>
 {res.type}
 </Badge>
 ...
 className={cn(
 "text-xs text-muted-foreground px-2 py-1 rounded-md border font-medium transition-colors",
 voted === v
 ? v === "For"
...
export default function CorpGovernancePage() {
 ...
 <TabsTrigger value="esg" className="rounded-none border-b-2 border-transparent data-[state=active]:border-foreground data-[state=active]:bg-transparent data-[state=active]:shadow-none px-3 py-2 text-xs text-muted-foreground data-[state=active]:text-foreground">ESG Scorecard</TabsTrigger>
 <TabsTrigger value="defense" className="rounded-none border-b-2 border-transparent data-[state=active]:border-foreground data-[state=active]:bg-transparent data-[state=active]:shadow-none px-3 py-2 text-xs text-muted-foreground data-[state=active]:text-foreground">Takeover Defenses</TabsTrigger>
 <TabsTrigger value="ownership" className="rounded-none border-b-2 border-transparent data-[state=active]:border-foreground data-[state=active]:bg-transparent data-[state=active]:shadow-none px-3 py-2 text-xs text-muted-foreground data-[state=active]:text-foreground">Institutional Ownership</TabsTrigger>
 </TabsList>
 ...
 className={cn(
 "text-xs text-muted-foreground px-2 py-1 rounded-md border transition-colors",
 ...
 <div>
 <p className="text-xs font-medium text-emerald-400 mb-2 flex items-center gap-1">Advantages</p>
 ...
 <div>
 <p className="text-xs font-medium text-rose-400 mb-2 flex items-center gap-1">Disadvantages</p>
 <ul className="space-y-1">
 {def.cons.map((c) => (
 ...
 <div className="space-y-1.5">
 <p className="text-muted-foreground font-medium flex items-center gap-1">Index Funds (Passive)</p>
 ...
 <div className="space-y-1.5">
 <p className="text-muted-foreground font-medium flex items-center gap-1">Hedge Funds (Active)</p>
 ...
 <div className="space-y-1.5">
 <p className="text-muted-foreground font-medium flex items-center gap-1">Insider Holdings</p>
