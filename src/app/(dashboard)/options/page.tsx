...
const TAB_TRIGGER_CLASS =
 "rounded-none border-b-2 border-transparent data-[state=active]:border-foreground data-[state=active]:bg-transparent data-[state=active]:shadow-none px-3 py-2 text-xs font-semibold text-muted-foreground/50 data-[state=active]:text-foreground data-[state=active]:font-semibold";
...
export default function OptionsPage() {
 ...
 <div>
 <p className="text-[10px] font-mono uppercase tracking-[0.3em] text-muted-foreground/30 mb-1">Derivatives</p>
 <h1 className="font-serif text-3xl font-bold tracking-tight leading-none">
 Options <span className="font-light text-muted-foreground/40">Chain</span>
 </h1>
 </div>
 <div className="flex items-center gap-3">
 <span className="font-mono text-lg tabular-nums font-semibold">${spotPrice.toFixed(2)}</span>
 </div>
 </div>
 </div>
 ...
 className="hidden md:block w-56 shrink-0 overflow-y-auto border-l border-border bg-card"
 >
 <ContractDetail
 ...
 <span className="text-xs font-mono uppercase tracking-[0.15em] text-muted-foreground/60">{currentTicker}</span>
 <span className="text-xs font-mono tabular-nums font-semibold">${spotPrice.toFixed(2)}</span>
 </div>
 ...
 <p className="shrink-0 border-t border-border px-3 py-1 text-center text-[10px] text-muted-foreground/40">
