...
export default function PrimeBrokeragePage() {
 ...
 <tr
 key={sec.ticker}
 className={cn("border-b border-border hover:bg-muted/40 transition-colors", i % 2 === 0 ? "bg-card/50" : "")}
 >
 ...
 <tr key={row.assetClass} className={cn("border-b border-border hover:bg-muted/40 transition-colors", i % 2 === 0 ? "" : "bg-muted/20")}>
 ...
 <tr key={row.feature} className={cn("border-b border-border hover:bg-muted/30 transition-colors", i % 2 === 0 ? "" : "bg-muted/20")}>
