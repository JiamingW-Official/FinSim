          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-border bg-foreground/5">
                ...
                <th className="py-2.5 px-3 text-center text-xs font-medium text-primary">CLMM (V3)</th>
              </tr>
            </thead>
            <tbody>
      ...
      <div>
        ...
        <div className="rounded-md border border-border bg-foreground/5 overflow-x-auto">
          <table className="w-full min-w-[540px]">
            ...
            <tbody>
              {LRTS.map((l) => (
                <tr key={l.token} className="border-b border-border/50 hover:bg-muted/30 transition-colors">
              ...
              <AnimatePresence>
                {expandedInst === i && (
                  <motion.div
                    ...
                    className="overflow-hidden"
                  >
                    <div className="px-3 pb-3 text-xs text-muted-foreground border-t border-border/50 pt-2">
                      {barrier.desc}
                    </div>
                  </motion.div>
                )}
    ...
    <div className="min-h-screen bg-background text-foreground p-4 md:p-6">
      ...
      >
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            <h1 className="text-xl font-bold text-foreground">DeFi 2.0 & Advanced Protocols</h1>
