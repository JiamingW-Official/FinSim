  ...
  return (
    <div className="max-w-lg mx-auto py-8 flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-5">
          ...
          {/* Explanation */}
          {revealed && (
            <div className={`border-l-2 pl-4 py-0.5 ${isCorrect ? "border-l-emerald-500/50" : "border-l-rose-500/40"}`}>
      ...
      {card ? (
        <div className="relative" style={{ perspective: 1000 }}>
          <div
            ...
            style={{ transformStyle: "preserve-3d", cursor: "pointer", transform: flipped ? "rotateY(180deg)" : "rotateY(0deg)", transition: "transform 0.4s" }}
    ...
    <div className="max-w-lg mx-auto py-8 flex flex-col gap-8">
      ...
      {dailyQuestion ? (
        <div className="flex flex-col gap-5">
          ...
          {revealed && (
            <div className={`border-l-2 pl-4 py-0.5 ${selected === dailyQuestion.correctIndex ? "border-l-emerald-500/50" : "border-l-rose-500/40"}`}>
...
export default function QuizPage() {
  return (
    <div className="max-w-5xl px-6 py-8 mx-auto space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Quiz &amp; Flashcards</h1>
        <p className="text-sm text-muted-foreground mt-1">Test knowledge · Master concepts · Build streaks</p>
      </div>
      ...
      <Tabs defaultValue="quiz">
        <TabsList className="bg-transparent border-b border-border rounded-none p-0 h-auto">
          {[
            ...
            <TabsTrigger
              key={value}
              value={value}
              className="data-[state=active]:border-b-2 data-[state=active]:border-primary data-[state=active]:shadow-none rounded-none bg-transparent px-4 py-2 text-xs text-muted-foreground data-[state=active]:text-foreground"
            >
              {label}
            </TabsTrigger>
          ))}
        ...
        <TabsContent value="quiz" className="data-[state=inactive]:hidden pt-4">
          <QuickQuizTab />
        </TabsContent>
        <TabsContent value="flashcards" className="data-[state=inactive]:hidden pt-4">
          <FlashcardsTab />
        </TabsContent>
        <TabsContent value="daily" className="data-[state=inactive]:hidden pt-4">
          <DailyChallengeTab />
        </TabsContent>
        <TabsContent value="stats" className="data-[state=inactive]:hidden pt-4">
          <MyStatsTab />
        </TabsContent>
      </Tabs>
    </div>
