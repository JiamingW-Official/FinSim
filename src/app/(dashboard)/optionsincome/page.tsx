...
function InfoBox({ children }: { children: React.ReactNode }) {
 return (
 <div className="flex gap-2 rounded-lg border border-border bg-muted/5 p-3 text-sm text-foreground">
...
function CashSecuredPutTab() {
 ...
 <div className="mt-4 p-3 rounded border border-border bg-muted/5 text-xs text-foreground space-y-1">
 <div className="font-semibold text-foreground">Wheel Strategy Flow</div>
...
export default function OptionsIncomePage() {
 ...
 {/* Header */}
 <div className="mb-6">
 <h1 className="text-3xl font-bold tracking-tight mb-1">Options Income Strategies</h1>
 <p className="text-sm text-muted-foreground">Education and simulator for premium-selling strategies</p>
 </div>
