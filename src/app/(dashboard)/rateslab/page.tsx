...
function SwapCurveTab() {
 ...
 <th className="text-right py-1.5 text-foreground font-medium">Par Rate</th>
...
function CrossCurrencyTab() {
 ...
 <div className="text-[11px] text-foreground">{fmtK(usdFlow)}</div>
...
function DurationHedgingTab() {
 ...
 <div className="text-xs text-foreground/40 ">Swap Portfolio</div>
 <SliderRow
 label="Swap Notional"
 value={swapNotional}
 min={5_000_000}
 ...
 <div className="text-xs text-foreground/40 pt-2 border-t border-border">Treasury Futures</div>
 <SliderRow
 ...
 <th className="text-right py-1 text-foreground">Futures P&L</th>
