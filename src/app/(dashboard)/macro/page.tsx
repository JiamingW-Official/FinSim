...
function HeatmapGrid({
 ...
 >
 <span className={`text-xs font-semibold ${textDark ? "text-background" : "text-foreground"}`}>{cell.country}</span>
...
export default function MacroDashboardPage() {
 ...
 <TabsTrigger value="inflation" className="rounded-none border-b-2 border-transparent data-[state=active]:border-foreground data-[state=active]:bg-transparent data-[state=active]:shadow-none px-3 py-2 text-xs text-muted-foreground data-[state=active]:text-foreground">
 <TrendingUp size={12} className="mr-1.5" /> Inflation
 </TabsTrigger>
 <TabsTrigger value="labor" className="rounded-none border-b-2 border-transparent data-[state=active]:border-foreground data-[state=active]:bg-transparent data-[state=active]:shadow-none px-3 py-2 text-xs text-muted-foreground data-[state=active]:text-foreground">
 ...
 <TabsTrigger value="regime" className="rounded-none border-b-2 border-transparent data-[state=active]:border-foreground data-[state=active]:bg-transparent data-[state=active]:shadow-none px-3 py-2 text-xs text-muted-foreground data-[state=active]:text-foreground">
 ...
 <tr key={row.c} className="border-b border-border/20 hover:bg-muted/30 transition-colors">
 ...
 <td className={`text-right py-2 ${row.cpi > 3.5 ? "text-red-400" : row.cpi < 1.5 ? "text-foreground" : "text-amber-400"}`}>
 {row.cpi.toFixed(1)}%
 </td>
 ...
 <td className={`text-right py-2 ${row.ca > 0 ? "text-foreground" : "text-red-400"}`}>
