...
export default function PaymentSystemsPage() {
 ...
 <span className="text-foreground font-semibold">Fedwire &amp; CHIPS</span> settle trillions
 daily in wholesale interbank payments despite low transaction counts.
 </div>
 <div className="bg-muted/50 rounded p-2 text-xs text-muted-foreground">
 <span className="text-foreground font-semibold">ACH &amp; SEPA</span> process billions of
 ...
 <div className="text-foreground font-medium mb-1">Example</div>
 ...
 <div className="bg-muted/10 border border-border rounded p-2">
 <div className="text-foreground font-medium mb-1">4-Party (Visa/MC)</div>
 <div className="text-muted-foreground">
 ...
 <div className="bg-muted/10 border border-border rounded p-2">
 <div className="text-foreground font-medium mb-1">3-Party (Amex/Discover)</div>
 <div className="text-muted-foreground">
 ...
 <th className="px-3 py-2 text-center text-foreground">RTP (TCH)</th>
 ...
 <div><span className="text-foreground">AISP:</span> Account Information Service Provider — read-only data aggregation</div>
 <div><span className="text-foreground">PISP:</span> Payment Initiation Service Provider — trigger bank transfers</div>
 <div><span className="text-foreground">CBPII:</span> Card-Based Payment Instrument Issuer — confirmation of funds</div>
 </div>
 </div>
 <div className="space-y-2">
 ...
 <td className="px-3 py-2 text-foreground">${c.annualBillion}B</td>
 ...
 { label: "Within 30 min", value: "40%", sub: "end-to-end", color: "text-foreground" },
 { label: "Payment tracking", value: "100%", sub: "UETR tracker", color: "text-foreground" },
 ...
 <div className="bg-muted/10 border border-border rounded p-2">
 <div className="text-foreground font-medium mb-1">Ripple (XRP Ledger)</div>
 ...
 <div className="bg-muted/10 border border-border rounded p-2">
 <div className="text-foreground font-medium mb-1">Stellar (XLM)</div>
 <ul className="space-y-1">
