...
const PERILS: PerilData[] = [
 { peril: "US Hurricane", share: 38, icon: <Wind size={14} />, color: "#3b82f6", colorClass: "text-foreground" },
 { peril: "US Earthquake", share: 20, icon: <Activity size={14} />, color: "#8b5cf6", colorClass: "text-foreground" },
 { peril: "Japan Earthquake", share: 10, icon: <Activity size={14} />, color: "#a855f7", colorClass: "text-foreground" },
 { peril: "Europe Windstorm", share: 12, icon: <Wind size={14} />, color: "#60a5fa", colorClass: "text-foreground" },
...
function CatBondMechanicsTab() {
 ...
 <div className="bg-muted/5 border border-border rounded-lg p-2">
 <span className="font-medium text-foreground block mb-0.5">1. Setup</span>
 Sponsor establishes an offshore SPV (Cayman Islands / Bermuda) and pays an annual premium for catastrophe protection.
 </div>
 <div className="bg-muted/5 border border-border rounded-lg p-2">
 <span className="font-medium text-foreground block mb-0.5">2. Issuance</span>
 ...
 selectedTrigger === t
 ? "bg-muted/10 text-foreground border-primary/30"
...
function PricingReturnsTab() {
 ...
 <td className="px-3 py-2 text-right text-foreground">{b.spread} bps</td>
 ...
 <div className="text-xs font-medium text-amber-400 mb-2">Pricing Framework</div>
...
function PerilAnalysisTab() {
 ...
 <td className="px-3 py-2 text-right text-foreground">${e.usEarthquake}B</td>
 ...
 <span className="text-xs font-medium text-green-400">Peril Diversification</span>
 </div>
