          ...
          >
            ...
            {expanded === c.key && (
              <motion.p
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                className="text-xs text-foreground mt-2 leading-relaxed border-t border-border/50 pt-2"
              >
                {c.detail}
              </motion.p>
            )}
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {premiumTable.map((row) => (
                <tr key={row.term} className="border-b border-border/30">
        ...
        {structures.map((s) => {
          ...
          return (
            <div key={s.title} className={cn("rounded-lg border p-4", borderMap[s.color])}>
              ...
              <div className="bg-muted/30 rounded px-3 py-2 text-xs text-foreground/80 border border-border/30">
