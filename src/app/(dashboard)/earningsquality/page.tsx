...
function ScreenerTab() {
 ...
 <div key={item.label} className="rounded-lg border border-border bg-foreground/[0.03] p-3">
 ...
 {/* Legend */}
 <div className="rounded-lg border border-border bg-foreground/[0.02] p-3 text-xs text-muted-foreground leading-relaxed">
...
function AccrualTab() {
 ...
 <div key={item.label} className="rounded-lg border border-border bg-foreground/[0.02] p-3">
...
function PiotroskiTab() {
 ...
 {/* F-Score summary */}
 <div className="rounded-md border border-border bg-foreground/[0.03] p-5 flex flex-col items-center justify-center gap-2">
 ...
 <div key={group.group} className="rounded-md border border-border bg-foreground/[0.03] p-4">
...
function BeneishTab() {
 ...
 {/* Variable bars */}
 <div className="rounded-md border border-border bg-foreground/[0.03] p-5 space-y-3">
...
export default function EarningsQualityPage() {
 ...
 <div key={stat.label} className="rounded-lg border border-border bg-foreground/[0.03] p-3 flex items-start gap-3">
