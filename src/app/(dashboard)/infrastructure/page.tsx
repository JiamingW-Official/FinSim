...
export default function InfrastructurePage() {
 ...
 "Core+": "bg-muted/10 text-foreground border-border",
 ...
 <div className="flex items-center gap-2">
 <span className="text-foreground">{selectedAsset.icon}</span>
 ...
 <Card
 key={vm.name}
 className={`bg-card border-border cursor-pointer transition-colors ${selectedValuation?.name === vm.name ? "ring-1 ring-blue-500" : "hover:border-muted-foreground/40"}`}
