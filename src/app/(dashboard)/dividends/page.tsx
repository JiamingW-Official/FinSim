    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <input
              ...
              className="flex-1 bg-muted/30 border border-border/40 rounded px-2 py-1.5 text-sm font-mono focus:outline-none focus:ring-1 focus:ring-primary/50"
            />
          </div>
        ...
        <div className="space-y-2">
          ...
          <div className="bg-muted/30 border border-border/40 rounded px-3 py-1.5 text-sm font-mono font-medium text-green-400">
            {fmt(divYield, 1)}%
          </div>
        ...
        <div className="space-y-2">
          ...
          <div className="bg-muted/30 border border-border/40 rounded px-3 py-1.5 text-sm font-mono font-medium">
            {years} years
          </div>
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-3 bg-muted/30 border border-border/40 rounded px-3 py-2">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <div className={cn("rounded-lg border p-3", milestone1k ? "bg-amber-500/5 border-amber-500/30" : "bg-muted/20 border-border/40")}>
