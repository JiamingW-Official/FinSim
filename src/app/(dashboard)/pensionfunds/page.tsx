...
function DBvsDCTab() {
 ...
 <p className="text-2xl font-semibold text-foreground">$56T</p>
 ...
 <p className="text-lg font-medium text-foreground">$7,131</p>
 ...
 <th className="text-left py-2 text-foreground font-medium">Defined Contribution (DC)</th>
 </tr>
 </thead>
 <tbody>
 ...
 <span className="text-sm font-semibold text-foreground">${sys.assets}T</span>
 </div>
 </div>
 ...
 <p className="text-sm font-medium text-foreground mb-1">Cash Balance Plan</p>
 ...
 <div className="p-3 rounded-lg bg-card/60 border border-border">
 <p className="text-sm font-medium text-foreground mb-1">Career Average Plan</p>
 <p className="text-xs text-muted-foreground">
 ...
 {/* Graded vesting */}
 <div>
 <p className="text-xs font-medium text-foreground mb-2">Graded Vesting (6-Year)</p>
 ...
 className="text-xs text-foreground underline mb-3 block"
 >
 ...
 <span className="text-foreground font-medium">$500B AUM</span>
 </div>
 <div className="flex justify-between p-2 rounded bg-card/50">
 <span className="text-muted-foreground">NY State Teachers</span>
 <span className="text-foreground font-medium">$135B AUM</span>
 </div>
 <div className="flex justify-between p-2 rounded bg-card/50">
 ...
 <span className="text-foreground font-medium">~$68B AUM</span>
 </div>
 <div className="flex justify-between p-2 rounded bg-card/50">
 <span className="text-muted-foreground">AT&T Pension</span>
 <span className="text-foreground font-medium">~$55B AUM</span>
 </div>
 <div className="flex justify-between p-2 rounded bg-card/50">
 <span className="text-muted-foreground">PBGC coverage</span>
 ...
 <div>
 <p className="text-xs font-medium text-foreground mb-2">ERISA Key Protections</p>
...
function LDITab() {
 ...
 { label: "PBGC Variable Rate", value: "$52/$1K", sub: "Per $1K underfunded", color: "text-foreground" },
 ].map((s) => (
 ...
 <div className="space-y-3">
 <div className="p-3 rounded-lg bg-card/60 border border-border">
 <p className="text-xs font-medium text-foreground mb-1">Interest Rate Swap Overlay</p>
 <p className="text-xs text-muted-foreground">
 ...
 <span className="font-medium text-foreground">PBGC Variable Premium</span>
 </div>
 <p className="text-xs text-muted-foreground">
...
function ActuarialTab() {
 ...
 <th className="text-left py-2 pr-4 text-foreground font-medium">Life Exp. Male (65)</th>
 ...
 <td className="py-2 pr-4 text-foreground font-medium">{row.lifeExpectancy65M} yrs</td>
 ...
 assumption.sensitivity === "Medium" ? "bg-muted text-foreground" :
 "bg-muted text-muted-foreground"
 }`}>
 ...
 <div className="flex items-center gap-3">
 <span className="text-sm font-medium text-foreground">{assumption.currentValue}</span>
 ...
 <p className="font-medium text-foreground mb-1">5-Year Average Value</p>
 <p className="text-muted-foreground">
 ...
 <div className="p-3 rounded bg-card/60 border border-border">
 <p className="font-medium text-foreground mb-1">Market Value of Assets (MVA)</p>
 <p className="text-muted-foreground">
...
function InvestmentStrategyTab() {
 ...
 { label: "Alternatives Allocation", value: "30%", sub: "US pensions avg (2024)", color: "text-foreground" },
 { label: "Norway GPFG AUM", value: "$1.8T", sub: "Largest pension fund", color: "text-foreground" },
 ...
 <div>
 <p className="text-xs font-medium text-foreground mb-3">Liability-Matching Glide Path</p>
 <div className="space-y-2">
 {[
 ...
 { funded: "90–100%", strategy: "De-risk; 35% RS / 65% hedge", color: "text-foreground" },
 ...
 <div>
 <p className="text-xs font-medium text-foreground mb-3">Risk Factor Approach</p>
 <div className="space-y-2 text-xs text-muted-foreground">
 {[
 ...
 <div>
 <span className="text-foreground font-medium">{row.factor} ({row.alloc}): </span>
 ...
 <div className="p-2 rounded bg-card/60 border border-border">
 <p className="text-foreground font-medium mb-1">Investment Committee</p>
...
export default function PensionFundsPage() {
 ...
 <InfoBadge label="Global AUM" value="$56 Trillion" color="text-foreground" />
