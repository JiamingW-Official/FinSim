...
function InfoBadge({ text }: { text: string }) {
 return (
 <span className="inline-flex items-center gap-1 text-xs text-foreground bg-muted/10 px-2 py-0.5 rounded-full">
 <Info size={10} />
 {text}
 </span>
 );
...
function CycleCard({
 ...
 <div>
 <p className="text-muted-foreground mb-1.5 ">Key Drivers</p>
 ...
 <div>
 <p className="text-muted-foreground mb-1.5 ">Peak Commodities</p>
...
export default function CommodityCyclesPage() {
 ...
 <div>
 <p className="text-2xl font-semibold text-amber-400">5</p>
 <p className="text-xs text-muted-foreground">Identified Cycles</p>
 </div>
 <div>
 <p className="text-lg font-medium text-foreground">25yr</p>
 ...
 <CardContent className="space-y-3">
 <div className="rounded-lg p-3 bg-muted/5 border border-border">
 ...
 <span className="text-foreground ml-1.5 font-mono text-xs">
 {v.ticker}
 </span>
 </td>
 <td className="py-2 pr-4">
