...
export default function CleantechPage() {
 ...
 <tbody>
 {NZE_PATHWAY.map((row) => (
 <tr key={row.metric} className="border-b border-border hover:bg-muted/30">
 ...
 <tbody>
 {CLEAN_ETFS.map((etf) => (
 <tr key={etf.ticker} className="border-b border-border hover:bg-muted/30">
 ...
 <tr key={row.region} className="border-b border-border hover:bg-muted/30">
