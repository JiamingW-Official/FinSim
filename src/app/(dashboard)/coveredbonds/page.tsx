...
function FrameworksTab() {
 ...
 <p className="leading-relaxed">The ECBD harmonised covered bond standards across EU member states, establishing minimum requirements for asset eligibility, OC levels, cover pool monitoring, liquidity buffers, and investor disclosure. Member states may apply stricter national rules — creating a two-tier structure of ECBD-compliant bonds and <span className="text-foreground">European Covered Bonds (Premium)</span> meeting enhanced criteria.</p>
 </div>
 ...
 <p>The exemption applies because covered bonds are <span className="text-foreground">secured liabilities backed by specific ring-fenced assets</span>. In resolution, the cover pool continues to service covered bonds under a special administrator, even if the issuing bank is placed in resolution.</p>
 </div>
...
function MarketDataTab() {
 ...
 <p>Covered bonds are <span className="text-foreground">ECB repo-eligible</span> as Category I collateral (haircut ~1–7%). The ECB's <span className="text-foreground">Covered Bond Purchase Programmes (CBPP1, CBPP2, CBPP3)</span> bought covered bonds outright to support euro area credit.</p>
 ...
 <div className="space-y-2 text-sm text-muted-foreground leading-relaxed">
 <p>Covered bonds rated <span className="text-foreground">AA– or above</span> qualify as <span className="text-foreground">Level 1B HQLA</span> under Basel III LCR (subject to 7% haircut and 70% cap within total HQLA).</p>
...
function ABSComparisonTab() {
 ...
 <th className="text-left text-foreground font-medium pb-2 pr-4">Covered Bond</th>
 <th className="text-left text-foreground font-medium pb-2">ABS / RMBS</th>
 </tr>
 </thead>
 <tbody>
 ...
 <span className="text-foreground">{row.coveredBond}</span>
 </div>
 </td>
 <td className="py-2">
 <span className="text-foreground">{row.abs}</span>
 </td>
 </tr>
 ))}
 </tbody>
 ...
 <div>
 <div className="text-foreground font-medium mb-1">Covered Bond Investors</div>
 ...
 <ArrowRight size={10} className="text-foreground shrink-0" />
 <span>{i}</span>
 </div>
 ))}
 </div>
 ...
 <div>
 <div className="text-foreground font-medium mb-1">ABS / RMBS Investors</div>
 <div className="space-y-0.5">
