...
function catColor(cat: "large-cap" | "high-vol" | "beat-history") {
 if (cat === "large-cap") return "bg-muted/10 text-foreground border border-border";
...
function CalendarTab() {
 ...
 className={cn("px-3 py-1 rounded transition-colors", showMonth === "march" ? "bg-primary text-foreground-foreground" : "text-muted-foreground hover:text-foreground")}
 >
 March
 </button>
 <button
 onClick={() => setShowMonth("april")}
 className={cn("px-3 py-1 rounded transition-colors", showMonth === "april" ? "bg-primary text-foreground-foreground" : "text-muted-foreground hover:text-foreground")}
 >
 April
 </button>
 </div>
 ...
 ev.category === "large-cap" ? "bg-muted/10 text-foreground" :
...
function EarningsAnalysisTab() {
 ...
 selectedTicker === ticker ? "bg-primary text-foreground-foreground" : "bg-muted text-muted-foreground hover:text-foreground"
 )}
 >
 {ticker}
 </button>
 ...
 <div className="bg-muted/5 border border-border rounded-lg p-3 space-y-2">
...
function EarningsStrategiesTab() {
 ...
 >
 <div className="flex items-center gap-3">
 <span className="text-xs font-medium text-foreground bg-muted/10 w-6 h-6 rounded-full flex items-center justify-center shrink-0">{i + 1}</span>
 <div>
 ...
 {/* Earnings Roulette */}
 <div className="bg-card border border-border rounded-lg overflow-hidden">
 <div className="px-4 py-3 bg-muted/5 border-b border-primary/20">
 ...
 rouletteTicker === ticker ? "bg-primary text-foreground-foreground" : "bg-muted text-muted-foreground hover:text-foreground"
 )}
 >
 {ticker}
 </button>
 ...
 className="w-full py-2.5 bg-primary text-foreground-foreground text-sm font-semibold rounded-lg hover:bg-primary/90 transition-colors"
 >
 Reveal Result
 </button>
 </>
 ...
 <div className={cn("text-xl font-semibold font-mono", rouletteResult.pnl >= 0 ? "text-emerald-400" : "text-red-400")}>
...
export default function EarningsPage() {
 ...
 <TabsTrigger value="ratings" className="rounded-none border-b-2 border-transparent data-[state=active]:border-foreground data-[state=active]:bg-transparent data-[state=active]:shadow-none px-3 py-2 text-xs text-muted-foreground data-[state=active]:text-foreground">
 Analyst Ratings
 </TabsTrigger>
 <TabsTrigger value="strategies" className="rounded-none border-b-2 border-transparent data-[state=active]:border-foreground data-[state=active]:bg-transparent data-[state=active]:shadow-none px-3 py-2 text-xs text-muted-foreground data-[state=active]:text-foreground">
 Strategies
 </TabsTrigger>
 <TabsTrigger value="deepdive" className="rounded-none border-b-2 border-transparent data-[state=active]:border-foreground data-[state=active]:bg-transparent data-[state=active]:shadow-none px-3 py-2 text-xs text-muted-foreground data-[state=active]:text-foreground">
 Deep Dive
 </TabsTrigger>
 </TabsList>
