...
function IndexMechanicsTab() {
 ...
 <p className="text-xs font-medium text-foreground mb-1">Securities Lending Revenue</p>
...
function FeeImpactTab() {
 ...
 <p className="text-lg font-semibold" style={{ color: ft.color }}>
 ...
 <div className="mt-4 p-4 rounded-md bg-muted/10 border border-border">
 <p className="text-sm font-medium text-foreground mb-1">The Verdict</p>
...
export default function ActivePassivePage() {
 ...
 <div>
 <h1 className="text-2xl font-semibold text-foreground">Active vs Passive Investing</h1>
 ...
 { label: "Fee gap over 40 years", value: "$1.7M", color: "text-foreground", sub: "$100K at 0.05% vs 2%" },
 ].map((stat) => (
 ...
 { value: "factors", label: "Factor Investing" },
 { value: "fees", label: "Fee Impact" },
 ].map((tab) => (
 <TabsTrigger
 key={tab.value}
 value={tab.value}
