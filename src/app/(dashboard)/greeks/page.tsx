...
function GreeksQuiz() {
 ...
 <button
 onClick={resetQuiz}
 className="px-4 py-2 rounded-lg bg-primary text-foreground-foreground text-sm font-medium hover:bg-primary/90 transition-colors"
 >
 Retry Quiz
 </button>
 </div>
 ...
 let cls =
 "w-full text-left p-3.5 rounded-md border text-sm transition-colors ";
 if (selected === null) {
 cls += "border-border bg-card hover:border-primary/40 hover:bg-muted/5 text-foreground";
 } else if (i === q.correct) {
 ...
 <button
 onClick={handleNext}
 className="mt-2 flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-primary text-foreground-foreground text-xs font-medium hover:bg-primary/90 transition-colors"
 >
...
export default function GreeksPage() {
 ...
 <TabsTrigger value="visualized" className="rounded-none border-b-2 border-transparent data-[state=active]:border-foreground data-[state=active]:bg-transparent data-[state=active]:shadow-none px-3 py-2 text-xs text-muted-foreground data-[state=active]:text-foreground">
 <BarChart2 className="size-3.5" />
 Visualized
 </TabsTrigger>
 <TabsTrigger value="second-order" className="rounded-none border-b-2 border-transparent data-[state=active]:border-foreground data-[state=active]:bg-transparent data-[state=active]:shadow-none px-3 py-2 text-xs text-muted-foreground data-[state=active]:text-foreground">
 ...
 <TabsTrigger value="simulator" className="rounded-none border-b-2 border-transparent data-[state=active]:border-foreground data-[state=active]:bg-transparent data-[state=active]:shadow-none px-3 py-2 text-xs text-muted-foreground data-[state=active]:text-foreground">
