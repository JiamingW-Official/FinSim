...
function GreeniumCalculator() {
 ...
 />
 <p className="text-sm font-mono text-foreground">{conventionalYield.toFixed(2)}%</p>
 </div>
 <div className="space-y-1">
 ...
 className="w-full accent-emerald-500"
 />
 <p className="text-sm font-mono text-foreground">{greeniumBps} bps</p>
 </div>
 <div className="space-y-1">
 ...
 className="w-full accent-emerald-500"
 />
 <p className="text-sm font-mono text-foreground">${issuanceSize}M</p>
 </div>
 </div>
 ...
 <p className="text-2xl font-semibold text-emerald-400">{greenBondYield.toFixed(2)}%</p>
 <p className="text-xs text-muted-foreground mt-1">vs {conventionalYield.toFixed(2)}% conventional</p>
 </div>
 <div className="rounded-lg border border-border bg-muted/5 p-4 text-center">
 <p className="text-xs text-muted-foreground mb-1">Annual Savings</p>
 <p className="text-lg font-medium text-foreground">${(annualSaving / 1000).toFixed(0)}K</p>
 ...
 <p className="text-lg font-medium text-foreground">${(tenYearSaving / 1e6).toFixed(2)}M</p>
...
export default function GreenFinancePage() {
 ...
 <TabsTrigger value="greenium" className="rounded-none border-b-2 border-transparent data-[state=active]:border-foreground data-[state=active]:bg-transparent data-[state=active]:shadow-none px-3 py-2 text-xs text-muted-foreground data-[state=active]:text-foreground">
 <DollarSign size={12} className="mr-1" /> Greenium Calc
 </TabsTrigger>
 <TabsTrigger value="taxonomy" className="rounded-none border-b-2 border-transparent data-[state=active]:border-foreground data-[state=active]:bg-transparent data-[state=active]:shadow-none px-3 py-2 text-xs text-muted-foreground data-[state=active]:text-foreground">
 <Globe size={12} className="mr-1" /> EU Taxonomy
 </TabsTrigger>
 <TabsTrigger value="carbon" className="rounded-none border-b-2 border-transparent data-[state=active]:border-foreground data-[state=active]:bg-transparent data-[state=active]:shadow-none px-3 py-2 text-xs text-muted-foreground data-[state=active]:text-foreground">
 <Target size={12} className="mr-1" /> Carbon Markets
 </TabsTrigger>
 <TabsTrigger value="instruments" className="rounded-none border-b-2 border-transparent data-[state=active]:border-foreground data-[state=active]:bg-transparent data-[state=active]:shadow-none px-3 py-2 text-xs text-muted-foreground data-[state=active]:text-foreground">
 ...
 <span className="text-xs font-semibold text-foreground truncate max-w-[140px]">{bond.issuer}</span>
 </div>
 ...
 <span className="text-foreground font-mono">{fmtYield(bond.yield)}</span>
 ...
 <CardTitle className="text-sm text-foreground">{selectedBond.issuer}</CardTitle>
 </div>
 </CardHeader>
 ...
 <span>Current: <strong className="text-foreground">€{euaPrice.toFixed(0)}/t</strong></span>
 <span>12m range: <strong className="text-foreground">€{Math.min(...etsPrices).toFixed(0)}–€{Math.max(...etsPrices).toFixed(0)}</strong></span>
 </div>
 </CardContent>
 </Card>
 ...
 <span className="text-foreground">{row.comp}</span>
 ...
 credit.market === "compliance" ? "bg-muted/10 text-foreground" : "bg-emerald-500/20 text-emerald-300"
 )}>
 {credit.market}
 </Badge>
 </div>
 ...
 <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
 {SFDR_TIERS.map((tier, i) => {
 const colors = ["text-emerald-400", "text-foreground", "text-muted-foreground"];
