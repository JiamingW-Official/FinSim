...
function MergerArbitrageTab() {
 ...
 <p className="text-xs text-muted-foreground font-semibold mb-2">Example Calculation</p>
...
function ActivismTab() {
 ...
 <p><span className="text-foreground font-medium">13D filing:</span> Required within 10 days of crossing 5% beneficial ownership threshold; discloses intent (Schedule 13D for active intent vs 13G for passive).</p>
 ...
 <div className="rounded-lg bg-muted/60 p-3">
 <p className="text-xs font-medium text-foreground mb-2">Odd-Lot Tender Premium</p>
...
function SpinoffsTab() {
 ...
 <CardContent className="space-y-3">
 <div className="rounded-lg bg-muted/60 p-3">
 <p className="text-xs font-medium text-foreground mb-1">Morris Trust</p>
...
function DistressedSPACTab() {
 ...
 <div className="rounded-lg bg-muted/60 p-3">
 <p className="text-xs font-medium text-foreground mb-1">Pure Arb Strategy (Pre-Deal)</p>
...
export default function EventDrivenPage() {
 ...
 { value: "spinoffs", label: "Spin-offs" },
 { value: "distressed", label: "Distressed & SPACs" },
 ].map(({ value, label }) => (
