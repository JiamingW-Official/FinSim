...
function AssetClassesTab() {
 ...
 <div className="text-sm font-semibold text-foreground">{sec.name}</div>
 ...
 <span className="text-muted-foreground">Inflation link: <span className="text-foreground">{selected.inflationLink}</span></span>
 </div>
 </div>
 </div>
 </motion.div>
...
function ProjectFinanceTab() {
 ...
 className="rounded-lg border border-border bg-muted/30 p-3 text-left hover:border-border transition-colors flex items-start gap-2"
 >
...
function InstitutionalTab() {
 ...
 <span className="text-foreground">Current: {fmtPct(pf.allocation)}</span>
 ...
 <span>Attribute</span>
 <span className="text-center text-foreground">Listed</span>
 ...
 <span className={cn("text-center font-medium", row.winner === "listed" ? "text-foreground" : "text-emerald-400")}>
 ...
 <div
 key={idx.name}
 className="rounded-lg border border-border bg-muted/30 p-3 flex items-start gap-3"
 >
 <Badge
 variant="outline"
 className={cn("text-xs flex-shrink-0 mt-0.5", idx.type === "Listed" ? "text-foreground border-primary/50" : "text-emerald-400 border-emerald-400/50")}
 >
 {idx.type}
 </Badge>
 <div>
...
export default function InfraInvestingPage() {
 ...
 <TabsTrigger value="project-finance" className="rounded-none border-b-2 border-transparent data-[state=active]:border-foreground data-[state=active]:bg-transparent data-[state=active]:shadow-none px-3 py-2 text-xs text-muted-foreground data-[state=active]:text-foreground">
 Project Finance
 </TabsTrigger>
 <TabsTrigger value="energy-transition" className="rounded-none border-b-2 border-transparent data-[state=active]:border-foreground data-[state=active]:bg-transparent data-[state=active]:shadow-none px-3 py-2 text-xs text-muted-foreground data-[state=active]:text-foreground">
 Energy Transition
 </TabsTrigger>
 <TabsTrigger value="institutional" className="rounded-none border-b-2 border-transparent data-[state=active]:border-foreground data-[state=active]:bg-transparent data-[state=active]:shadow-none px-3 py-2 text-xs text-muted-foreground data-[state=active]:text-foreground">
 Institutional
 </TabsTrigger>
 </TabsList>
