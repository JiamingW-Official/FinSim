...
function FuturesCurveTab() {
 ...
 className={selectedCurve === i ? "bg-primary text-foreground-foreground" : ""}
 >
 {c.name}
 </Button>
 ))}
...
function HedgingTab() {
 ...
 <span className="text-foreground font-medium">{contractsNeeded}</span>
 </div>
 </CardContent>
 </Card>
...
export default function CommoditiesFuturesPage() {
 ...
 <TabsTrigger value="seasonality" className="rounded-none border-b-2 border-transparent data-[state=active]:border-foreground data-[state=active]:bg-transparent data-[state=active]:shadow-none px-3 py-2 text-xs text-muted-foreground data-[state=active]:text-foreground">
 Seasonality
 </TabsTrigger>
 ...
 <TabsTrigger value="sectors" className="rounded-none border-b-2 border-transparent data-[state=active]:border-foreground data-[state=active]:bg-transparent data-[state=active]:shadow-none px-3 py-2 text-xs text-muted-foreground data-[state=active]:text-foreground">
 Sectors
 </TabsTrigger>
 </TabsList>
