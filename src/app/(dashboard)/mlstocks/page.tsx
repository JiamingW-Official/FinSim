...
export default function MLStocksPage() {
 ...
 <div key={cat.name} className={`rounded-lg p-3 border border-border ${cat.bgColor}`}>
 ...
 <div key={row.cost} className="flex items-start justify-between text-xs text-muted-foreground py-1.5 border-b border-border">
 <div>
 ...
 return (
 <tr key={sig.ticker} className="border-b border-border hover:bg-muted/20 transition-colors">
 <td className="py-1.5">
