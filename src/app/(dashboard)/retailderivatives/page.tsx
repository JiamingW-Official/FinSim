...
function ExchangeTradedOptionsTab() {
 ...
 color: "border-primary/40 bg-muted/5",
 items: [
 ...
 row.type === "Equity" ? "bg-muted/10 text-foreground" : row.type === "ETF" ? "bg-muted/10 text-foreground" : "bg-emerald-500/20 text-emerald-400"
 )}
 >
 {row.type}
 </span>
 ...
 <th className="text-left py-2 pr-4 text-foreground">Options</th>
...
function LeveragedETFsTab() {
 ...
 >
 <p className="font-semibold text-foreground text-sm">{etf.ticker}</p>
...
function StructuredNotesTab() {
 ...
 "Leveraged": "bg-muted/10 text-foreground border-border",
 ...
 selected?.id === note.id ? "bg-muted/10" : "hover:bg-muted/30"
 )}
 >
 ...
 <p className="text-foreground">Option leg: <span className="text-foreground">{selected.embeddedOption}</span></p>
 ...
 <p>Issue Price: <span className="text-foreground">$1,000.00</span></p>
 <p>Fair Value est.: <span className="text-foreground">${selected.fairValue}</span></p>
...
function WarrantsRightsTab() {
 ...
 <td className="px-4 py-2.5 font-medium text-foreground font-mono">{w.ticker}</td>
...
function RetailAlternativesTab() {
 ...
 "Interval Fund": "bg-muted/10 text-foreground",
 "Non-Traded REIT": "bg-muted/10 text-foreground",
 ...
 <div className="space-y-4">
 {/* Info Banner */}
 <div className="rounded-md border border-border bg-muted/5 p-4 flex items-start gap-3">
 <Info size={16} className="text-foreground mt-0.5 flex-shrink-0" />
 <div className="text-sm">
 <p className="font-medium text-foreground mb-1">Democratization of Alternative Investments</p>
...
export default function RetailDerivativesPage() {
 ...
 <TabsTrigger value="leveraged" className="rounded-none border-b-2 border-transparent data-[state=active]:border-foreground data-[state=active]:bg-transparent data-[state=active]:shadow-none px-3 py-2 text-xs text-muted-foreground data-[state=active]:text-foreground">
 Leveraged & Inverse ETFs
 </TabsTrigger>
 <TabsTrigger value="structured" className="rounded-none border-b-2 border-transparent data-[state=active]:border-foreground data-[state=active]:bg-transparent data-[state=active]:shadow-none px-3 py-2 text-xs text-muted-foreground data-[state=active]:text-foreground">
 Structured Notes
 </TabsTrigger>
 <TabsTrigger value="warrants" className="rounded-none border-b-2 border-transparent data-[state=active]:border-foreground data-[state=active]:bg-transparent data-[state=active]:shadow-none px-3 py-2 text-xs text-muted-foreground data-[state=active]:text-foreground">
 Warrants & Rights
 </TabsTrigger>
