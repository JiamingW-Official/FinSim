...
function OverviewTab() {
  ...
  return (
    <div className="space-y-4">
      {isDemoData && (
        <div className="rounded-lg border border-border/50 bg-muted/30 px-4 py-2.5 text-xs text-muted-foreground">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
        <Card>
          <CardContent className="p-4">
            ...
            <p className="mt-1 text-2xl font-bold">{stats.beta.toFixed(2)}</p>
        ...
        <TabsList className="flex h-auto flex-wrap gap-1 bg-transparent p-0">
          {[
            ...
            <TabsTrigger
              key={t.value}
              value={t.value}
              className="rounded-md border border-border/50 bg-card px-3 py-1.5 text-xs data-[state=active]:border-primary/50 data-[state=active]:bg-primary/10 data-[state=active]:text-primary"
            >
              {t.label}
            </TabsTrigger>
          ))}
