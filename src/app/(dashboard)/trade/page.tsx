...
export default function TradePage() {
 ...
 <p className="shrink-0 border-t border-border px-3 py-0.5 text-center text-[9px] font-mono text-muted-foreground/30">
 ...
 <p className="shrink-0 border-t border-border px-3 py-0.5 text-center text-[9px] font-mono text-muted-foreground/30 md:hidden">
 Simulated trading -- not financial advice
 </p>
 </>
 );
