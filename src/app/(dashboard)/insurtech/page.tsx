...
function BusinessModelsTab() {
 ...
 high: "bg-muted/10 text-foreground",
 extreme: "bg-muted/10 text-foreground",
 };
 return (
 <span className={cn("rounded-full px-2 py-0.5 text-[11px] font-semibold ", styles[level])}>
 {level}
 </span>
 );
 };
 ...
 <span className="text-[11px] rounded-full bg-muted/10 text-foreground px-2 py-0.5 font-medium">Incumbent</span>
 )}
 {row.winner === "tie" && (
...
function ParametricTab() {
 ...
 <span className="text-foreground">{wt.basisRisk}</span>
 </div>
 </div>
 </div>
 ))}
 ...
 <span className="text-sm font-mono font-semibold tabular-nums text-foreground">{droughtSeverity}</span>
 </div>
 <input
 type="range"
 min={0}
 ...
 <div>
 <h3 className="text-xs font-medium text-foreground mb-1">Cat Bond Connection</h3>
 ...
 <div className="text-sm font-medium font-mono text-foreground">${d.issuance.toFixed(1)}B</div>
 <div className="text-[11px] text-muted-foreground">issuance {d.year}</div>
 <div className="text-xs text-foreground font-mono">+{d.spread.toFixed(1)}% spread</div>
 </div>
 ))}
 </div>
 </div>
...
function AIDataTab() {
 ...
 { label: "Average (10k mi)", saving: "~16% savings", color: "text-foreground" },
...
function MarketDynamicsTab() {
 ...
 {[
 { label: "Peak quarter (Q2 2021)", value: "$5.4B", color: "text-foreground" },
 ...
 <span className="text-[11px] text-foreground">{deal.target}</span>
 </div>
 ...
 deal.type === "acquisition" ? "bg-muted/10 text-foreground"
 : deal.type === "investment" ? "bg-muted/10 text-foreground"
 ...
 <div>
 <h3 className="text-xs font-medium text-foreground mb-1">Regulatory Sandbox Participation</h3>
 <p className="text-[11px] text-muted-foreground leading-relaxed mb-3">
 ...
 <div key={item.label} className="rounded bg-muted/10 p-2 text-center">
 <div className="text-sm font-medium font-mono text-foreground">{item.value}</div>
 ...
 <div className="space-y-2">
 <h4 className="text-xs font-medium text-red-400 ">Loss Ratio Struggles</h4>
 {[
 ...
 <div className="space-y-2">
 <h4 className="text-xs font-medium text-emerald-400 ">Paths to Sustainability</h4>
 {[
 ...
 {[
 { label: "Global InsurTech market", value: "$142B", sub: "2024 market size", icon: <DollarSign className="h-4 w-4" />, color: "text-foreground" },
 { label: "Premium digitized", value: "18%", sub: "vs. 3% in 2018", icon: <BarChart2 className="h-4 w-4" />, color: "text-foreground" },
...
export default function InsurtechPage() {
 ...
 <div className="flex items-center gap-1.5">
 <span className="text-[11px] rounded-full bg-muted/10 text-foreground px-2 py-0.5 font-medium ">
 Sector Analysis
 </span>
 <span className="text-[11px] rounded-full bg-muted/10 text-foreground px-2 py-0.5 font-medium ">
 Interactive
 ...
 {/* Callout — Hero */}
 <div className="flex gap-2.5 rounded-lg border border-border bg-muted/5 border-l-4 border-l-primary p-6">
 <Info className="h-3.5 w-3.5 text-muted-foreground/50 shrink-0 mt-0.5" />
 <p className="text-[11px] text-foreground/70 leading-relaxed">
 <span className="font-medium text-foreground">What is InsurTech?</span>{""}
