...
export default function CryptoTrading2Page() {
 ...
 { value: "derivatives", label: "Derivatives Deep Dive" },
 ].map((tab) => (
 <TabsTrigger
 key={tab.value}
 value={tab.value}
 ...
 <Badge className="text-xs bg-muted/10 text-foreground border-border">
 ...
 <p className="text-xs text-foreground/40 font-medium mb-2">Mechanics</p>
