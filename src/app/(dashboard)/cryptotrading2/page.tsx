  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white p-4 md:p-6 space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
        <TabsList className="bg-white/5 border border-white/10 rounded-xl p-1 flex flex-wrap gap-1 h-auto">
          {[
            ...
            <TabsTrigger
              key={tab.value}
              value={tab.value}
              className="flex items-center gap-1.5 text-xs px-3 py-2 rounded-lg data-[state=active]:bg-white/15 data-[state=active]:text-white text-white/50"
            >
              {tab.icon}
              {tab.label}
            </TabsTrigger>
        ...
        <TabsContent value="market-structure" className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              <Card key={card.title} className="bg-white/3 border-white/8">
        ...
        <TabsContent value="strategies" className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {arbitrageOpps.map((opp) => (
              ...
              >
                <Card className="bg-white/3 border-white/8 h-full">
                  <CardHeader className="pb-3">
          ...
          <Card className="bg-white/3 border-white/8">
            ...
            <CardContent className="space-y-3">
              {cryptoRisks.map((risk) => (
                <div
                  key={risk.name}
                  className="bg-white/3 rounded-xl p-4 border border-white/6 space-y-2"
                >
                  <div className="flex items-start justify-between gap-2">
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        <Badge className="text-xs bg-white/8 text-white/50 border-white/10">
                          {risk.category}
                        </Badge>
                      </div>
            ...
            <Card className="bg-white/3 border-white/8">
              ...
              <CardContent className="space-y-2.5">
                {[
                  ...
                  <div key={item.setup} className="bg-white/4 rounded-lg p-3 space-y-1">
