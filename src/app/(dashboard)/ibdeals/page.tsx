...
function typeColor(t: DealType): string {
 ...
 Acquisition: "bg-muted/10 text-foreground border-border",
 Merger: "bg-muted/10 text-foreground border-border",
...
export default function IBDealsPage() {
 ...
 <div className="mb-6">
 <h1 className="text-3xl font-bold tracking-tight mb-1">Investment Banking Deal Simulator</h1>
 <p className="text-sm text-muted-foreground">Live M&amp;A tracker, deal structuring, fairness opinions, regulatory review, LBO models, and league tables.</p>
 </div>
 ...
 <td className="px-4 py-2 text-center">
 {d.crossBorder ? (
 <span className="text-foreground font-medium">{d.origin} → {d.destination}</span>
 ) : (
 ...
 {[
 { label: "Offer EV", value: fmtB(dealCalcs.offeredEV), color: "text-foreground" },
 ...
 { label: "EV/Revenue (offer)", value: `${fmt(dealCalcs.impliedEvRevenue)}×`, color: "text-foreground" },
 ...
 <div className="text-sm font-medium text-foreground">{fmtM(dealCalcs.debtFinancing)}</div>
 </div>
 <div className="bg-muted/50 rounded p-2">
 <div className="text-xs text-muted-foreground">Equity Financing</div>
 <div className="text-sm font-medium text-foreground">{fmtM(Math.max(0, dealCalcs.equityFinancing))}</div>
 </div>
 </div>
 {/* Financing bar */}
 ...
 <div
 style={{ width: `${cashMix}%` }}
 className="bg-primary transition-colors duration-300"
 title={`Cash: ${cashMix}%`}
 />
 <div
 ...
 {c.name === selectedTarget && <span className="text-foreground text-[11px]">TARGET</span>}
 {c.name}
 </td>
 ...
 <td className="px-3 py-2 text-right text-foreground">{fmt(c.evRevenue)}×</td>
 ...
 <td className="px-3 py-2 text-right text-foreground">{fmt(p.evRevenue)}×</td>
 ...
 {[
 { label: "Entry EV", value: fmtB(lboCalcs.entryEV), color: "text-foreground" },
 ...
 <div className="font-medium text-xs text-foreground mb-1">{f.type}</div>
