...
function EarlyWarningDashboard() {
 ...
 <div className={cn("text-lg font-semibold", isDanger ? "text-red-400" : "text-yellow-400")}>
 {ind.value}
...
function CrisisAnatomyTab() {
 ...
 <div className="bg-muted/50 rounded p-2">
 <div className="text-foreground font-semibold mb-1">Liquidity Spiral</div>
 <div className="text-muted-foreground leading-tight">
...
function CrisisGenerationModels() {
 ...
 <div
 className="w-8 h-8 rounded-full flex items-center justify-center text-xs font-semibold text-foreground shrink-0"
...
function CurrencyCrisesTab() {
 ...
 <div>
 <span className="text-xs text-red-400 font-medium ">Trigger: </span>
 <span className="text-[11px] text-muted-foreground">{CURRENCY_CRISES[selectedCase].trigger}</span>
 </div>
 <div>
 <span className="text-xs text-yellow-400 font-medium ">Response: </span>
 <span className="text-[11px] text-muted-foreground">{CURRENCY_CRISES[selectedCase].response}</span>
 </div>
 <div>
 <span className="text-xs text-green-400 font-medium ">Outcome: </span>
...
function SovereignDebtTab() {
 ...
 <div className="bg-muted/50 rounded p-2">
 <div className="text-foreground font-medium mb-1">Debt Sustainability (DSA)</div>
 <div className="text-muted-foreground leading-tight">
...
function CrisisInvestingTab() {
 ...
 <div>
 <span className="text-[11px] text-foreground font-medium ">Examples: </span>
 <span className="text-xs text-muted-foreground">{theme.examples}</span>
 </div>
 <div>
 <span className="text-[11px] text-green-400 font-medium ">Entry: </span>
 <span className="text-xs text-muted-foreground">{theme.entry}</span>
 </div>
 <div>
 <span className="text-[11px] text-yellow-400 font-medium ">Timing: </span>
