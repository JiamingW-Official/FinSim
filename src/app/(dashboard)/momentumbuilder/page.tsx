...
export default function MomentumBuilderPage() {
 ...
 <span className="text-sm text-foreground font-mono">{lookback}M</span>
 </div>
 <Slider
 min={1} max={12} step={1}
 value={[lookback]}
 ...
 <span className="text-sm text-foreground font-mono">{skipPeriod}M</span>
 </div>
 <Slider
 min={0} max={1} step={1}
 value={[skipPeriod]}
 ...
 <span className="text-sm text-foreground font-mono">{portfolioSize} stocks</span>
 </div>
 <Slider
 ...
 { label: "Alpha vs S&P", value: `+${stats.alpha}%`, color: "text-foreground" },
 { label: "Sharpe", value: stats.sharpe.toFixed(2), color: "text-foreground" },
 ...
 <td className={`p-2 text-right font-mono ${row.alpha >= 0 ? "text-foreground" : "text-orange-400"}`}>
 {row.alpha > 0 ? "+" : ""}{row.alpha}%
 </td>
 <td className="p-2 text-right font-mono text-foreground">{row.sharpe}</td>
 ...
 <p className="text-xs font-medium text-foreground mb-1">Current Params</p>
 <p className="text-xs text-muted-foreground">
