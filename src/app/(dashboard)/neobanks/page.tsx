...
export default function NeobanksPage() {
 ...
 <TabsTrigger value="unit-economics" className="rounded-none border-b-2 border-transparent data-[state=active]:border-foreground data-[state=active]:bg-transparent data-[state=active]:shadow-none px-3 py-2 text-xs text-muted-foreground data-[state=active]:text-foreground">
 Unit Economics
 </TabsTrigger>
 <TabsTrigger value="vs-traditional" className="rounded-none border-b-2 border-transparent data-[state=active]:border-foreground data-[state=active]:bg-transparent data-[state=active]:shadow-none px-3 py-2 text-xs text-muted-foreground data-[state=active]:text-foreground">
 vs Traditional Banks
 </TabsTrigger>
 <TabsTrigger value="market-dynamics" className="rounded-none border-b-2 border-transparent data-[state=active]:border-foreground data-[state=active]:bg-transparent data-[state=active]:shadow-none px-3 py-2 text-xs text-muted-foreground data-[state=active]:text-foreground">
 Market Dynamics
 </TabsTrigger>
 </TabsList>
 ...
 <td className="py-2.5 px-3 text-muted-foreground">{nb.customers}M</td>
 <td className="py-2.5 px-3 text-muted-foreground">${nb.revenue}B</td>
 <td className="py-2.5 px-3 text-muted-foreground">${nb.valuation}B</td>
 <td className="py-2.5 px-3 text-muted-foreground">${nb.revenuePerUser}</td>
 <td className="py-2.5 px-3 text-muted-foreground">${nb.cac}</td>
 <td className="py-2.5 px-3 text-muted-foreground">{nb.market}</td>
 <td className="py-2.5 px-3">
 <Badge
 variant="outline"
 ...
 * Revenue/User = annual revenue ÷ active customers. CAC = blended customer acquisition cost (USD). Data as of 2024.
 ...
 <p>
 <span className="text-foreground font-medium">Interchange:</span> Card swipe fees (~1.5–2%) split between card network and issuer.
 </p>
 <p>
 <span className="text-foreground font-medium">Interest Income:</span> Rapidly growing as neobanks expand lending books.
 </p>
 <p>
 <span className="text-foreground font-medium">Premium Subs:</span> Metal/Plus tiers — Revolut Metal ($16.99/mo), Monzo Premium (£15/mo).
 </p>
 </div>
 </CardContent>
 </Card>
 ...
 <p className={`text-xl font-semibold ${kpi.color} mt-1`}>{kpi.value}</p>
 </div>
 ))}
 </div>
 ...
 <CardHeader className="pb-3">
 <CardTitle className="text-sm font-medium text-foreground flex items-center gap-2">
 Cost-to-Income Ratio (CIR) — Traditional vs Neobank
 </CardTitle>
 </CardHeader>
 <CardContent>
 <CIRChart />
 ...
 <span className={`text-xs w-20 flex-shrink-0 ${isNeo ? "text-indigo-300" : "text-muted-foreground"}`}>
 {b.name}
 </span>
 ...
 <span className={`text-xs w-36 flex-shrink-0 ${item.type === "neobank" ? "text-indigo-300" : "text-muted-foreground"}`}>
 {item.channel}
 </span>
 ...
 <span className="text-xs text-muted-foreground w-10 text-right">${item.cost}</span>
 </div>
 );
 })}
 </div>
 ...
 <CardHeader className="pb-3">
 <CardTitle className="text-sm font-medium text-foreground flex items-center gap-2">
 Speed of Innovation — Feature Releases per Year
 </CardTitle>
 </CardHeader>
 <CardContent>
 <FeatureCadenceChart />
 ...
 <div key={item.title} className="bg-muted rounded-lg p-3">
 ...
 <CardHeader className="pb-3">
 <CardTitle className="text-sm font-medium text-foreground flex items-center gap-2">
 Global Neobank Users (Millions, 2018–2024)
 </CardTitle>
 </CardHeader>
 <CardContent>
 <GlobalUsersChart />
 ...
 {isFuture && (
 <span className="text-xs text-muted-foreground italic">forecast</span>
 )}
 </div>
 </div>
 );
