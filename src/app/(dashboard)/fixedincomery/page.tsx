...
export default function FixedIncomeRVPage() {
 ...
 <div className="text-2xl font-semibold mb-1">118 <span className="text-sm text-muted-foreground font-normal">bps OAS</span></div>
 ...
 row.type === "Agency" && "bg-muted/10 text-foreground",
