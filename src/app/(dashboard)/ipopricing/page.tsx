...
function ValuationMethodsTab() {
 ...
 <tr key={row.type} className={cn("border-b border-border", i % 2 === 0 ? "bg-foreground/[0.02]" : "")}>
...
function BookbuildingTab() {
 ...
 const k = keys[req];
 return (
 <tr key={req} className={cn("border-b border-border", i % 2 === 0 ? "bg-foreground/[0.02]" : "")}>
 ...
 <tr key={row.company} className={cn("border-b border-border", i % 2 === 0 ? "bg-foreground/[0.02]" : "")}>
...
function UnderpricingTab() {
 ...
 <tr key={row.period} className={cn("border-b border-border", i % 2 === 0 ? "bg-foreground/[0.02]" : "")}>
