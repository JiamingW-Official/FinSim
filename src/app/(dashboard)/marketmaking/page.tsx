...
function Tab101() {
 ...
 <p>
 With high volume, even a 1 cent spread on 10 million shares/day = <span className="text-amber-400 font-semibold">$100,000/day</span>.
 </p>
 ...
 <div className="text-amber-400 font-mono text-xs font-semibold">{m.val}</div>
 </div>
 ))}
 </div>
 </div>
...
function TabSpread() {
 ...
 <div className="bg-muted rounded p-3">
 <div className="text-foreground font-medium mb-1">Risk-Aversion Effect</div>
...
function TabAMM() {
 ...
 <span>Metric</span>
 <span className="text-foreground">AMM (Uniswap v2/v3)</span>
 <span className="text-foreground">CLOB (NYSE / Binance)</span>
 </div>
 {comparisons.map((c) => (
 <div
 key={c.metric}
...
function TabHFT() {
 ...
 <div className="text-foreground font-medium text-sm mb-2">HFT Market Making</div>
 <div className="space-y-1 text-xs text-muted-foreground">
 ...
 <div className="bg-muted rounded-lg p-3">
 <div className="text-foreground font-medium text-sm mb-2">Statistical Arbitrage</div>
 <div className="space-y-1 text-xs text-muted-foreground">
...
export default function MarketMakingPage() {
 ...
 {[
 { label: "Citadel MM Volume", val: "~25%", sub: "US equities", color: "text-foreground" },
 ...
 { label: "Co-lo Latency", val: "< 1 μs", sub: "NYSE data center", color: "text-foreground" },
