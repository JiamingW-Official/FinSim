...
function DirectLendingTab() {
 ...
 <tr key={row.attr} className={cn("border-b border-border", i % 2 === 0 ? "bg-foreground/[0.02]" : "")}>
 ...
 <div key={item.term} className="rounded-lg border border-border bg-foreground/[0.03] p-3">
...
function MezzanineTab() {
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
 {specialSit.map((s) => (
 <div key={s.category} className="rounded-lg border border-border bg-foreground/[0.03] p-3">
...
function DistressedTab() {
 ...
 {definitions.map((d) => (
 <div key={d.term} className="rounded-lg border border-border bg-foreground/[0.03] p-3 text-center">
 ...
 <div key={item.label} className="rounded-lg border border-border bg-foreground/[0.03] p-4">
 ...
 <div className="space-y-3">
 {opCredit.map((s) => (
 <div key={s.type} className="flex items-start gap-3 rounded-lg border border-border bg-foreground/[0.03] p-3">
...
function MarketDynamicsTab() {
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
 {risks.map((risk) => (
 <div key={risk.risk} className="rounded-lg border border-border bg-foreground/[0.03] p-3">
