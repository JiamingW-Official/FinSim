...
function GreeksSensitivityTab() {
 ...
 {
 greek: "Rho (ρ)", color: "text-foreground",
...
function InvestmentStrategiesTab() {
 ...
 <div className={cn("flex items-center gap-2 text-base font-semibold mb-2", colorClasses[s.color].text)}>
 {s.icon} {s.name}
 </div>
...
function RiskAnalysisTab() {
 ...
 <div className="h-full rounded-full transition-colors" style={{ width: `${rk.severity * 10}%`, background: rk.color }} />
 </div>
 </div>
 <div className="flex-1">
 <div className="text-xs text-muted-foreground mb-1">Likelihood</div>
 <div className="h-1.5 bg-muted rounded-full overflow-hidden">
 <div className="h-full rounded-full bg-muted-foreground transition-colors" style={{ width: `${rk.likelihood * 10}%` }} />
 </div>
 </div>
 </div>
