...
export default function QuantResearchPage() {
 ...
 <div key={src.name} className="rounded-lg bg-muted/50 border border-border p-3 space-y-2">
 <div className="flex items-start justify-between gap-2">
 ...
 return (
 <div key={m.name} className="rounded-lg bg-muted/50 border border-border p-3 space-y-2">
 ...
 {m.features.map((f) => (
 <span key={f} className="text-xs bg-muted/50 border border-border text-muted-foreground rounded px-1.5 py-0.5">{f}</span>
 ))}
 </div>
