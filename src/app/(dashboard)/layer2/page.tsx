...
function RollupTechnology() {
 ...
 <span className="text-sm font-medium text-foreground">ZK Rollups</span>
 <Badge variant="outline" className="text-xs border-border text-foreground ml-auto">Instant finality</Badge>
 </div>
 ...
 <th className="text-left px-4 py-2 text-foreground">ZK Rollup</th>
 ...
 {row.winner === "zk" ? (
 <span className="text-xs text-foreground font-medium">ZK</span>
...
function DeveloperEcosystem() {
 ...
 <tr className="text-xs text-muted-foreground border-b border-border">
 <th className="text-left px-4 py-2">Feature</th>
 <th className="text-center px-4 py-2 text-foreground">Arbitrum</th>
 <th className="text-center px-4 py-2 text-red-400">Optimism</th>
 <th className="text-center px-4 py-2 text-foreground">zkSync</th>
 ...
 <th className="text-right px-4 py-2 text-foreground">Arbitrum</th>
...
function InvestmentThesis() {
 ...
 s === "live" ? "text-emerald-400 border-emerald-700" : s === "upcoming" ? "text-foreground border-border" : "text-foreground border-border";
