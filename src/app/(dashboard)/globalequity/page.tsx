...
function ValuationTab() {
 ...
 <span className="text-sm font-semibold text-emerald-400">{v.pe.toFixed(1)}x</span>
 ...
 <Badge variant="outline" className={cn("text-xs", v.type === "EM" ? "border-amber-700 text-amber-400" : "border-border text-foreground")}>{v.type}</Badge>
 </td>
...
function CountryDeepDivesTab() {
 ...
 className={cn(
 "flex items-center gap-1.5 px-3 py-1.5 text-xs text-muted-foreground font-medium rounded-md border transition-colors",
 ...
 <span className="text-xs font-medium text-foreground">{stk.ticker}</span>
 ...
 <div className="h-full bg-muted/50 rounded-full" style={{ width: `${(stk.weight / 12) * 100}%` }} />
 </div>
 </div>
 </div>
 ))}
...
function CurrencyImpactTab() {
 ...
 color: "text-foreground border-border bg-muted/30",
 points: [
...
function EMvsDMTab() {
 ...
 <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
 {[
 { label: "DM Avg Return", val: dmAvgReturn.toFixed(1) + "%", color: "text-foreground" },
 { label: "EM Avg Return", val: emAvgReturn.toFixed(1) + "%", color: "text-amber-400" },
 { label: "DM Avg Volatility", val: dmAvgVol.toFixed(1) + "%", color: "text-foreground" },
 ...
 <span className="text-foreground">DM {f.dmScore.toFixed(1)}</span>
 ...
 <td className="px-3 py-2">
 <Badge variant="outline" className={cn("text-xs", d.type === "EM" ? "border-amber-700 text-amber-400" : "border-border text-foreground")}>{d.type}</Badge>
 </td>
...
export default function GlobalEquityPage() {
 ...
 <TabsTrigger value="currency" className="rounded-none border-b-2 border-transparent data-[state=active]:border-foreground data-[state=active]:bg-transparent data-[state=active]:shadow-none px-3 py-2 text-xs text-muted-foreground data-[state=active]:text-foreground">Currency Impact</TabsTrigger>
 <TabsTrigger value="emdm" className="rounded-none border-b-2 border-transparent data-[state=active]:border-foreground data-[state=active]:bg-transparent data-[state=active]:shadow-none px-3 py-2 text-xs text-muted-foreground data-[state=active]:text-foreground">EM vs DM</TabsTrigger>
 </TabsList>
