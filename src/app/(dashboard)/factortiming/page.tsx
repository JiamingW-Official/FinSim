        ...
        {sel && (
          ...
          >
            ...
            <div className="mt-3 flex items-center gap-4">
              ...
              <span className="text-sm font-bold" style={{ color: sel.color }}>
                {fmtZ(sel.zScore)}
              </span>
            </div>
          </motion.div>
...
export default function FactorTimingPage() {
  ...
  const tabs = [
    { id: "dashboard", label: "Factor Dashboard", icon: <BarChart3 className="w-4 h-4" /> },
    { id: "momentum", label: "Cross-Asset Momentum", icon: <Activity className="w-4 h-4" /> },
    { id: "cycle", label: "Factor Cycle", icon: <RefreshCw className="w-4 h-4" /> },
    { id: "tactical", label: "Tactical Allocation", icon: <Target className="w-4 h-4" /> },
    { id: "implementation", label: "Implementation", icon: <Zap className="w-4 h-4" /> },
  ];
