    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {painPoints.map((p) => (
            <div key={p.issue} className="bg-white/5 rounded-xl p-3 flex gap-3">
        ...
        <div className="bg-white/5 rounded-xl overflow-hidden">
          ...
          {eBolProviders.map((e) => (
            <div
              key={e.name}
              className={cn(
                "grid grid-cols-5 gap-2 px-4 py-3 text-xs border-b border-white/5",
    ...
    <div className="min-h-screen bg-[#0a0a0f] text-white">
      <div className="max-w-5xl mx-auto px-4 py-8">
        ...
        >
          ...
          <div className="flex flex-wrap gap-2 mt-4">
            {[
              ...
              <div
                key={kpi.label}
                className="bg-white/5 rounded-lg px-3 py-1.5 flex items-center gap-2"
              >
        ...
        <Tabs defaultValue="lc">
          <TabsList className="flex flex-wrap h-auto gap-1 bg-white/5 p-1 rounded-xl mb-6">
            {tabs.map((tab) => {
              const Icon = tab.icon;
              return (
                <TabsTrigger
