...
export const UNIT_OPTIONS_GREEKS: Unit = {
 ...
 correctIndex: 1,
 explanation:
 "Time value scales with T (square root of time). The decay rate is the derivative: d(T)/dT = 1/(2T). As T decreases, 1/(2T) increases — so near-expiry options decay much faster per day. With 7 days left vs 30 days, the decay rate ratio is approximately (30/7) 2.07, roughly matching the $0.065 vs $0.140 ratio.",
 difficulty: 2,
 },
 {
 type: "quiz-scenario",
