    ...
    // ─── Lesson 3: AMM Mathematics & Liquidity Provision ────────────────────────
    {
      ...
      steps: [
        ...
        },
        {
          type: "quiz-mc",
          question:
            "You provide equal-value liquidity to a Uniswap v2 ETH/USDC pool when ETH = $2,000. ETH price rises to $4,000 (r = 2). Using IL = 2√r/(1+r) - 1, what is your approximate impermanent loss versus holding?",
          options: [
