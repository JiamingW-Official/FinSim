...
export const unitVolatilityArbitrage: Unit = {
  ...
  lessons: [
    ...
    {
      id: "vol-arb-3",
      title: "⚙️ Volatility Strategies In Practice",
      description:
    ...
    {
      id: "vol-arb-4",
      title: "🛡️ Tail Hedging & Volatility Skew",
      description:
