...
export const UNIT_RISK_MANAGEMENT_MASTERY: Unit = {
 ...
 correct: false,
 explanation:
 "Positive expected value (EV = 0.4×3 0.6×1 = 0.6) does NOT guarantee profitability with poor sizing. Oversized bets can cause ruin before the edge has time to play out. The Kelly Criterion shows this trader should risk f* = (3×0.40.6)/3 = 0.6/3 = 20%, not 50% or 100%.",
 difficulty: 3,
 },
 {
 type: "quiz-scenario",
