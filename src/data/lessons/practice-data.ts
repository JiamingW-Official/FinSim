...
export const PRACTICE_UPTREND = {
 ...
 count: 60, startPrice: 100, seed: 42,
 drift: 0.004, volatility: 0.014,
 meanReversion: 0.03, target: 112,
 momentumBias: 0.6,
...
export const PRACTICE_UP_DOWN = {
 bars: generateRealisticBars({
 count: 60, startPrice: 100, seed: 101,
...
export const PRACTICE_VOLATILE = {
 bars: generateRealisticBars({
 count: 60, startPrice: 150, seed: 200,
...
export const PRACTICE_LIMIT_DIP = {
 bars: generateRealisticBars({
 count: 60, startPrice: 100, seed: 301,
...
export const PRACTICE_SMA_CROSS = {
 bars: generateRealisticBars({
 count: 60, startPrice: 100, seed: 401,
 drift: 0.002, volatility: 0.013,
 meanReversion: 0.05, target: 106,
 momentumBias: 0.6,
 consolidation: [
...
export const PRACTICE_RSI_BOUNCE = {
 bars: generateRealisticBars({
 count: 60, startPrice: 120, seed: 501,
...
export const PRACTICE_MACD_SIGNAL = {
 bars: generateRealisticBars({
 count: 60, startPrice: 100, seed: 601,
...
export const PRACTICE_BB_SQUEEZE = {
 bars: generateRealisticBars({
 count: 60, startPrice: 100, seed: 701,
...
export const PRACTICE_BASIC = {
 bars: generateRealisticBars({
 count: 60, startPrice: 100, seed: 800,
 drift: 0.001, volatility: 0.013,
 meanReversion: 0.04, target: 103,
 momentumBias: 0.5,
...
export const PRACTICE_CANDLES = {
 bars: generateRealisticBars({
 count: 60, startPrice: 100, seed: 900,
 drift: 0.002, volatility: 0.018,
 meanReversion: 0.03, target: 106,
 momentumBias: 0.5,
...
export const PRACTICE_VOLUME = {
 bars: generateRealisticBars({
 count: 60, startPrice: 100, seed: 1000,
...
export const PRACTICE_MARKET_ORDER = {
 bars: generateRealisticBars({
 count: 60, startPrice: 150, seed: 1100,
 drift: 0.003, volatility: 0.012,
 meanReversion: 0.02, target: 158,
 momentumBias: 0.6,
...
export const PRACTICE_POSITION_SIZE = {
 bars: generateRealisticBars({
 count: 60, startPrice: 50, seed: 1200,
 drift: 0.002, volatility: 0.015,
 meanReversion: 0.04, target: 53,
 momentumBias: 0.55,
...
export const PRACTICE_SUPPORT_RESISTANCE = {
 bars: generateRealisticBars({
 count: 60, startPrice: 101, seed: 1300,
...
export const PRACTICE_RISK_REWARD = {
 bars: generateRealisticBars({
 count: 60, startPrice: 100, seed: 1400,
 drift: 0.001, volatility: 0.016,
 meanReversion: 0.07, target: 104,
 momentumBias: 0.55,
 consolidation: [{ start: 30, end: 38, tightness: 0.4 }],
 patterns: [
...
export const PRACTICE_DRAWDOWN = {
 bars: generateRealisticBars({
 count: 60, startPrice: 100, seed: 1500,
 drift: -0.004, volatility: 0.022,
 meanReversion: 0.02, target: 85,
 momentumBias: 0.6,
